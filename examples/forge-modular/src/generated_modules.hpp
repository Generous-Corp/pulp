...
// ── CLOCKWEAVE (6HP) ──────────────────────────────────
struct CLOCKWEAVELayout {
    static constexpr int kHp = 6;
    enum ParamId { RATE_PARAM, WIDTH_PARAM, PARAMS_LEN };
    enum InputId { RATE_CV_INPUT, RESET_INPUT, INPUTS_LEN };
    enum OutputId { CLOCK_OUTPUT, PHASE_OUTPUT, OUTPUTS_LEN };
    enum LightId { LIGHTS_LEN };
};

inline void config_CLOCKWEAVE(rack::engine::Module* m) {
    m->config(CLOCKWEAVELayout::PARAMS_LEN, CLOCKWEAVELayout::INPUTS_LEN, CLOCKWEAVELayout::OUTPUTS_LEN, CLOCKWEAVELayout::LIGHTS_LEN);
    m->configParam(CLOCKWEAVELayout::RATE_PARAM, -3.0f, 3.0f, 0.0f, "Rate", " Hz", 2.0f, 2.0f);
    m->configParam(CLOCKWEAVELayout::WIDTH_PARAM, 0.05f, 0.95f, 0.5f, "Pulse width", "%", 0.0f, 100.0f);
    m->configInput(CLOCKWEAVELayout::RATE_CV_INPUT, "Rate CV (normalled to 0.0V)");
    m->configInput(CLOCKWEAVELayout::RESET_INPUT, "Reset (normalled to 0.0V)");
    m->configOutput(CLOCKWEAVELayout::CLOCK_OUTPUT, "Clock");
    m->configOutput(CLOCKWEAVELayout::PHASE_OUTPUT, "Phase");
}

/// RATE_CV_INPUT with its declared normal applied.
inline float read_CLOCKWEAVE_RATE_CV_INPUT(rack::engine::Module* m, int c) {
    return m->inputs[CLOCKWEAVELayout::RATE_CV_INPUT].getNormalPolyVoltage(0.0f, c);
}

/// RESET_INPUT with its declared normal applied.
inline float read_CLOCKWEAVE_RESET_INPUT(rack::engine::Module* m, int c) {
    return m->inputs[CLOCKWEAVELayout::RESET_INPUT].getNormalPolyVoltage(0.0f, c);
}

inline void place_CLOCKWEAVE(rack::app::ModuleWidget* w, rack::engine::Module* m) {
    using namespace rack;
    using namespace rack::componentlibrary;
    w->addChild(createWidgetCentered<forge_modular::ForgeScrew>(mm2px(Vec(7.620f, 2.54f))));
    w->addChild(createWidgetCentered<forge_modular::ForgeScrew>(mm2px(Vec(7.620f, 126.153f))));
    w->addChild(createWidgetCentered<forge_modular::ForgeScrew>(mm2px(Vec(22.860f, 2.54f))));
    w->addChild(createWidgetCentered<forge_modular::ForgeScrew>(mm2px(Vec(22.860f, 126.153f))));
    w->addParam(createParamCentered<forge_modular::ForgeKnobMedium>(mm2px(Vec(15.240f, 31.000f)), m, CLOCKWEAVELayout::RATE_PARAM));
    w->addParam(createParamCentered<forge_modular::ForgeKnobMedium>(mm2px(Vec(15.240f, 54.000f)), m, CLOCKWEAVELayout::WIDTH_PARAM));
    w->addInput(createInputCentered<forge_modular::ForgePort>(mm2px(Vec(8.800f, 80.000f)), m, CLOCKWEAVELayout::RATE_CV_INPUT));
    w->addInput(createInputCentered<forge_modular::ForgePort>(mm2px(Vec(21.700f, 80.000f)), m, CLOCKWEAVELayout::RESET_INPUT));
    w->addOutput(createOutputCentered<forge_modular::ForgePort>(mm2px(Vec(8.800f, 108.000f)), m, CLOCKWEAVELayout::CLOCK_OUTPUT));
    w->addOutput(createOutputCentered<forge_modular::ForgePort>(mm2px(Vec(21.700f, 108.000f)), m, CLOCKWEAVELayout::PHASE_OUTPUT));
}
...
inline void config_PULSEARC(rack::engine::Module* m) {
    m->config(PULSEARCLayout::PARAMS_LEN, PULSEARCLayout::INPUTS_LEN, PULSEARCLayout::OUTPUTS_LEN, PULSEARCLayout::LIGHTS_LEN);
    m->configParam(PULSEARCLayout::RATE_PARAM, -3.0f, 3.0f, 0.0f, "Rate", " Hz", 2.0f, 2.0f);
    m->configParam(PULSEARCLayout::WIDTH_PARAM, 0.05f, 0.95f, 0.5f, "Pulse width", "%", 0.0f, 100.0f);
    m->configInput(PULSEARCLayout::RATE_CV_INPUT, "Rate CV (normalled to 0.0V)");
    m->configInput(PULSEARCLayout::RESET_INPUT, "Reset");
    m->configOutput(PULSEARCLayout::CLOCK_OUTPUT, "Clock");
    m->configOutput(PULSEARCLayout::PHASE_OUTPUT, "Phase");
}

/// RATE_CV_INPUT with its declared normal applied.
inline float read_PULSEARC_RATE_CV_INPUT(rack::engine::Module* m, int c) {
    return m->inputs[PULSEARCLayout::RATE_CV_INPUT].getNormalPolyVoltage(0.0f, c);
}

inline void place_PULSEARC(rack::app::ModuleWidget* w, rack::engine::Module* m) {
    using namespace rack;
    using namespace rack::componentlibrary;
    w->addChild(createWidgetCentered<forge_modular::ForgeScrew>(mm2px(Vec(7.620f, 2.54f))));
    w->addChild(createWidgetCentered<forge_modular::ForgeScrew>(mm2px(Vec(7.620f, 126.153f))));
    w->addChild(createWidgetCentered<forge_modular::ForgeScrew>(mm2px(Vec(22.860f, 2.54f))));
    w->addChild(createWidgetCentered<forge_modular::ForgeScrew>(mm2px(Vec(22.860f, 126.153f))));
    w->addParam(createParamCentered<forge_modular::ForgeKnobMedium>(mm2px(Vec(8.800f, 30.000f)), m, PULSEARCLayout::RATE_PARAM));
    w->addParam(createParamCentered<forge_modular::ForgeKnobMedium>(mm2px(Vec(21.700f, 30.000f)), m, PULSEARCLayout::WIDTH_PARAM));
    w->addInput(createInputCentered<forge_modular::ForgePort>(mm2px(Vec(8.800f, 70.000f)), m, PULSEARCLayout::RATE_CV_INPUT));
    w->addInput(createInputCentered<forge_modular::ForgePort>(mm2px(Vec(21.700f, 70.000f)), m, PULSEARCLayout::RESET_INPUT));
    w->addOutput(createOutputCentered<forge_modular::ForgePort>(mm2px(Vec(8.800f, 105.000f)), m, PULSEARCLayout::CLOCK_OUTPUT));
    w->addOutput(createOutputCentered<forge_modular::ForgePort>(mm2px(Vec(21.700f, 105.000f)), m, PULSEARCLayout::PHASE_OUTPUT));
}
