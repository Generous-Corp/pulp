//! The DSP core for the PulpRustGain example plugin: a real Rust stereo gain
//! implementing the Pulp native-component Processor-level C ABI. A C++
//! NativeCoreProcessor adapter owns it, and pulp_add_plugin packages it as a
//! loadable CLAP plugin — proving a Rust DSP core ships as a real plugin.
//!
