...
# the loaded shell watches ($HOME/.pulp/hot-reload-synth/logic.dylib). Edit
...
cmake --build "$BUILD_DIR" --target hot-reload-synth-logic
echo "Published: $HOME/.pulp/hot-reload-synth/logic.dylib"
