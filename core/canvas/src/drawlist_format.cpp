...
void append_color(std::string& out, const Color& color) {
    char buffer[64];
    std::snprintf(buffer, sizeof(buffer), "rgba(%.3f %.3f %.3f %.3f)", color.r, color.g, color.b,
                  color.a);
    out += buffer;
}
...
const char* draw_command_name(DrawCommand::Type type) {
    ...
    case T::stroke_rect:
        return "stroke_rect";
    case T::fill_rounded_rect:
        return "fill_rounded_rect";
    case T::stroke_rounded_rect:
        return "stroke_rounded_rect";
    case T::fill_circle:
        return "fill_circle";
    case T::stroke_circle:
    ...
    case T::set_text_align:
        return "set_text_align";
    case T::fill_text:
        return "fill_text";
    case T::stroke_text:
        return "stroke_text";
    case T::set_font_full:
        return "set_font_full";
    case T::set_line_dash:
        return "set_line_dash";
    case T::draw_image:
        return "draw_image";
    case T::write_pixels:
        return "write_pixels";
    case T::draw_box_shadow:
        return "draw_box_shadow";
    case T::set_shadow_color:
        return "set_shadow_color";
    case T::set_shadow_blur:
        return "set_shadow_blur";
    case T::set_shadow_offset_x:
        return "set_shadow_offset_x";
    case T::set_shadow_offset_y:
        return "set_shadow_offset_y";
    case T::set_miter_limit:
        return "set_miter_limit";
    case T::set_image_smoothing:
        return "set_image_smoothing";
    case T::set_direction:
        return "set_direction";
    case T::set_filter:
        return "set_filter";
    case T::set_fill_pattern:
        return "set_fill_pattern";
    case T::set_stroke_pattern:
        return "set_stroke_pattern";
    case T::set_stroke_gradient_linear:
        return "set_stroke_gradient_linear";
    case T::set_stroke_gradient_radial:
        return "set_stroke_gradient_radial";
    case T::set_stroke_gradient_radial_two_circles:
        return "set_stroke_gradient_radial_two_circles";
    case T::set_stroke_gradient_conic:
        return "set_stroke_gradient_conic";
    case T::clear_stroke_gradient:
        return "clear_stroke_gradient";
    case T::set_fill_gradient_linear:
        return "set_fill_gradient_linear";
    case T::set_fill_gradient_radial:
        return "set_fill_gradient_radial";
    case T::set_fill_gradient_radial_two_circles:
        return "set_fill_gradient_radial_two_circles";
    case T::set_fill_gradient_conic:
        return "set_fill_gradient_conic";
    case T::clear_fill_gradient:
        return "clear_fill_gradient";
    case T::fill_path_object:
        return "fill_path_object";
    case T::stroke_path_object:
        return "stroke_path_object";
    case T::clip_path_object:
        return "clip_path_object";
    case T::draw_path_shadow:
        return "draw_path_shadow";
    case T::begin_layer:
        return "begin_layer";
    case T::end_layer:
        return "end_layer";
    case T::draw_layer:
        return "draw_layer";
    case T::draw_layer_fitted:
        return "draw_layer_fitted";
    case T::draw_layer_rotated:
        return "draw_layer_rotated";
    case T::invalidate_layer:
        return "invalidate_layer";
    case T::save_backdrop_filter:
        return "save_backdrop_filter";
    case T::clip_path_svg:
        return "clip_path_svg";
    case T::clear_rect:
        return "clear_rect";
    case T::begin_path:
        return "begin_path";
    ...
    case T::close_path:
        return "close_path";
    case T::fill_current_path:
        return "fill_current_path";
    case T::stroke_current_path:
        return "stroke_current_path";
    case T::arc:
        return "arc";
    case T::arc_to:
        return "arc_to";
    ...
    case T::save_layer:
        return "save_layer";
    case T::save_layer_blend:
        return "save_layer_blend";
    case T::save_layer_filters:
        return "save_layer_filters";
    case T::save_layer_mask:
        return "save_layer_mask";
    case T::save_layer_bloom:
        return "save_layer_bloom";
    case T::draw_sksl:
        return "draw_sksl";
    }
    return "unknown";
