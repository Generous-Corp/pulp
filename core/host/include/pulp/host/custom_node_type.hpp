...
// ── Sample-region scalar callback ABI ─────────────────────────────────
// This is a sibling contract rather than part of CustomNodeType so the
// historical aggregate layout and positional initializers remain unchanged.
