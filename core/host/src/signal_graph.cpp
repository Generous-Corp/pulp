...
// mutations (add_*, connect*, disconnect, remove_node) invalidate the
// snapshot; prepare() rebuilds a fresh CompiledGraph and atomic-swaps it in.
// Scalar gain updates are reflected into the live snapshot separately. See
// signal_graph.hpp for the mutation protocol details.
