...
void append_lofi(Nodes& nodes) {
    ...
    add(nodes, forge_lofi::delay_descriptor(),
    ...
    add(nodes, forge_lofi::drywet_descriptor(),
        {realization("default", forge_lofi::make_drywet_node())});
    add(nodes, forge_lofi::noise_descriptor(),
    ...
    add(nodes, forge_lofi::bitcrush_descriptor(),
        {realization("legacy", forge_lofi::make_bitcrush_node()),
         ...
         realization("tpdf_first", forge_lofi::make_bitcrush_node(
                                       signal::DitherMode::tpdf, signal::NoiseShapingOrder::first)),
         realization("tpdf_second",
                     forge_lofi::make_bitcrush_node(signal::DitherMode::tpdf,
                                                    signal::NoiseShapingOrder::second))});
    add(nodes, forge_lofi::trim_descriptor(),
    ...
    add(nodes, forge_lofi::reverb_descriptor(),
    ...
    add(nodes, forge_lofi::gate_descriptor(),
    ...
    add(nodes, forge_lofi::width_descriptor(),
        {realization("default", forge_lofi::make_width_node())});
    add(nodes, forge_lofi::phaser_descriptor(),
