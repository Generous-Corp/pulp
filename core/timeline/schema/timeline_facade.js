...
export const timelineSchema = Object.freeze({
  ...
  "pulp.timeline.command.insert_device": Object.freeze({
    schemaType: "pulp.timeline.command.insert_device",
    domain: "Command",
    version: 1,
    fields: Object.freeze([
      Object.freeze({ name: "before_device_id", kind: "U64String", jsType: "string", required: false }),
      Object.freeze({ name: "placement", kind: "Object", jsType: "object", required: true, ref: "pulp.timeline.device_placement" }),
      Object.freeze({ name: "sequence_id", kind: "U64String", jsType: "string", required: true }),
      Object.freeze({ name: "track_id", kind: "U64String", jsType: "string", required: true }),
    ]),
  }),
  ...
  "pulp.timeline.command.move_device": Object.freeze({
    schemaType: "pulp.timeline.command.move_device",
    domain: "Command",
    version: 1,
    fields: Object.freeze([
      Object.freeze({ name: "device_id", kind: "U64String", jsType: "string", required: true }),
      Object.freeze({ name: "expected_before_device_id", kind: "U64String", jsType: "string", required: false }),
      Object.freeze({ name: "replacement_before_device_id", kind: "U64String", jsType: "string", required: false }),
      Object.freeze({ name: "sequence_id", kind: "U64String", jsType: "string", required: true }),
      Object.freeze({ name: "track_id", kind: "U64String", jsType: "string", required: true }),
    ]),
  }),
  ...
  "pulp.timeline.command.remove_device": Object.freeze({
    schemaType: "pulp.timeline.command.remove_device",
    domain: "Command",
    version: 1,
    fields: Object.freeze([
      Object.freeze({ name: "device_id", kind: "U64String", jsType: "string", required: true }),
  ...
  "pulp.timeline.command.retarget_device": Object.freeze({
    schemaType: "pulp.timeline.command.retarget_device",
    domain: "Command",
    version: 1,
    fields: Object.freeze([
      Object.freeze({ name: "device_id", kind: "U64String", jsType: "string", required: true }),
  ...
  "pulp.timeline.command.set_device_state": Object.freeze({
    schemaType: "pulp.timeline.command.set_device_state",
    domain: "Command",
    version: 1,
    fields: Object.freeze([
      Object.freeze({ name: "device_id", kind: "U64String", jsType: "string", required: true }),
      Object.freeze({ name: "expected", kind: "String", jsType: "string", required: false }),
      Object.freeze({ name: "replacement", kind: "String", jsType: "string", required: false }),
      Object.freeze({ name: "sequence_id", kind: "U64String", jsType: "string", required: true }),
      Object.freeze({ name: "track_id", kind: "U64String", jsType: "string", required: true }),
    ]),
  }),
  ...
  "pulp.timeline.device_placement": Object.freeze({
    ...
    version: 2,
    fields: Object.freeze([
      Object.freeze({ name: "binding_key", kind: "String", jsType: "string", required: true }),
      Object.freeze({ name: "bypassed", kind: "Boolean", jsType: "boolean", required: true }),
      Object.freeze({ name: "device_kind", kind: "String", jsType: "string", required: true }),
      Object.freeze({ name: "id", kind: "U64String", jsType: "string", required: true }),
      Object.freeze({ name: "position", kind: "String", jsType: "string", required: true }),
      Object.freeze({ name: "slot_kind", kind: "String", jsType: "string", required: true }),
      Object.freeze({ name: "state_ref", kind: "String", jsType: "string", required: false }),
      Object.freeze({ name: "wet_dry_bits", kind: "U32", jsType: "number", required: true }),
    ]),
  }),
  ...
  "pulp.timeline.sequence": Object.freeze({
    ...
    fields: Object.freeze([
      ...
      Object.freeze({ name: "dynamics_lane", kind: "Array", jsType: "array", required: true }),
