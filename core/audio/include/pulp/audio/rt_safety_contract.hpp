...
inline constexpr std::array kSamplerLooperRtSafetyContracts{
    ...
    detail::make_rt_safety_contract(
        ...
        false,
        false,
        "audio reader over an immutable asset publication",
        "Metadata, preload pointer, and stream identity reads do not mutate the asset."),
    detail::make_rt_safety_contract(
        "PreparedSampleInterpolation",
        "footprint_evaluate",
        RtSafetyClass::AudioCallbackSafeWithImmutableInputs,
        true,
        false,
        ...
        false,
        false,
        "renderer over prepared interpolation state and caller-owned taps",
        "Footprint resolution and evaluation are bounded arithmetic over fixed spans."),
    detail::make_rt_safety_contract(
        "LoopPlaybackCursor",
        "frame_read_plan_advance",
        RtSafetyClass::AudioCallbackSafeAfterPrepare,
        true,
        false,
        false,
        false,
        true,
        "audio-owned cursor with an immutable validated loop region",
        "Read planning and cursor advancement mutate only bounded per-voice state."),
    detail::make_rt_safety_contract(
        "SampleStreamRequestInbox",
        "try_push_pop",
        RtSafetyClass::AudioCallbackSafeAfterPrepare,
        true,
        false,
        ...
        false,
        true,
        "one demand producer and one scheduler consumer",
        "Fixed-capacity SPSC demand publication drops overflow instead of allocating."),
    detail::make_rt_safety_contract(
        "SampleStreamCommandInbox",
        "demand_cancel",
        RtSafetyClass::AudioCallbackSafeAfterPrepare,
        true,
        false,
        ...
        false,
        true,
        "one audio command producer and one cache-service consumer",
        "Demand and cancellation commands carry fixed-size tokens through SPSC storage."),
    detail::make_rt_safety_contract(
        "SampleStreamService",
        "begin_complete_audio_page_read",
        RtSafetyClass::AudioCallbackSafeAfterPrepare,
        true,
        false,
        false,
        false,
        true,
        "audio reader bracketing immutable page-view access",
        "Epoch entry and completion protect cache-page reclamation without locks."),
    detail::make_rt_safety_contract(
        "SampleStreamVoiceReader",
        "plan_render",
        RtSafetyClass::AudioCallbackSafeAfterPrepare,
        true,
        false,
        ...
        false,
        true,
        "audio-owned forward voice reader over prepared asset and page views",
        "Narrow one-shot planning and rendering use fixed demand and tap storage."),
    detail::make_rt_safety_contract(
        "SampleStreamLoopVoiceReader",
        "plan_render",
        RtSafetyClass::AudioCallbackSafeAfterPrepare,
        true,
        false,
        ...
        false,
        true,
        "audio-owned loop voice reader over prepared asset and page views",
        "Loop-aware planning and rendering use fixed demand, page, cursor, and tap storage."),
    detail::make_rt_safety_contract(
        "SampleStarvationEnvelope",
        "next_gain",
        RtSafetyClass::AudioCallbackSafeAfterPrepare,
        true,
        false,
        ...
        false,
        true,
        "per-voice starvation state owner",
        "Gain transitions are bounded arithmetic over prepared fade lengths."),
    detail::make_rt_safety_contract(
        "SampleAsset",
        "prepare_release",
        RtSafetyClass::ControlThreadOnly,
        ...
        true,
        false,
        "serialized asset owner after realtime readers quiesce",
        "Preparation copies or adopts preload storage and publishes immutable metadata."),
    detail::make_rt_safety_contract(
        "SampleStreamService",
        "prepare_mutate_cache",
        RtSafetyClass::ControlThreadOnly,
        false,
        true,
        true,
        true,
        false,
        "single cache-service owner",
        "Preparation, fill completion, eviction, cancellation, and reclamation mutate shared cache state."),
    detail::make_rt_safety_contract(
        "SampleStreamDecodePool",
        "decode_work",
        RtSafetyClass::BackgroundThreadOnly,
        false,
        false,
        ...
        true,
        true,
        "registered source worker selected by the decode pool",
        "Workers may wait, call decoder bindings, and publish completion records."),
    detail::make_rt_safety_contract(
        "SampleStreamAsyncService",
        "owner_work",
        RtSafetyClass::BackgroundThreadOnly,
        false,
        true,
        ...
        true,
        true,
        "single async-service owner coordinating cache and decode workers",
        "Demand draining, reservations, completion handling, and retirement are off callback."),
    detail::make_rt_safety_contract(
        "SampleMemoryGovernorHandle",
        "reserve_stats",
        RtSafetyClass::ControlThreadOnly,
        false,
        true,
        ...
        true,
        false,
        "sampler memory-budget owner",
        "Reservations and statistics lock shared accounting and may create lease ownership."),
    detail::make_rt_safety_contract(
        "SampleMemoryLease",
        "reset_release",
        RtSafetyClass::ControlThreadOnly,
        ...
        true,
        false,
        "lease owner outside realtime processing",
        "Lease reset and destruction return bytes through locked shared accounting."),
    detail::make_rt_safety_contract(
        "LoopPointAnalyzer",
        "analyze",
        RtSafetyClass::BackgroundThreadOnly,
