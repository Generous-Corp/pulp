...
using GpuAudioTransportTrialDeliveryFn = void (*)(void*, std::uint64_t, std::uint8_t, std::uint64_t,
                                                  std::uint64_t, std::uint64_t) noexcept;

bool configure_gpu_audio_transport_trial_observer(GpuAudioTransport&, void*,
                                                  GpuAudioTransportTrialDeliveryFn) noexcept;
