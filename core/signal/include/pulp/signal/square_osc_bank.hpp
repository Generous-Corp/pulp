...
/// into one output.
///
/// This is a reusable excitation source for metallic and electronic sounds:
/// callers choose any number of independently tuned, weighted square
/// oscillators, then apply their own filtering and amplitude envelope.
///
