...
int main() {
    ...
    }
    {
        ...
        auto volatile binding_49 = static_cast<bool (*)(const float*, const float*, float*, float*, std::size_t) noexcept>(&pulp::signal::mid_side_encode_block<float>);
        (void)binding_49;
        auto volatile binding_50 = static_cast<bool (*)(float, std::span<float>) noexcept>(&pulp::signal::nway_constant_power_gains<float>);
        (void)binding_50;
    ...
    }
    {
        ...
        auto volatile binding_72 = &pulp::timebase::division_ticks;
        (void)binding_72;
    ...
    }
    {
        ...
        auto volatile binding_74 = &pulp::timebase::coordinate_chance;
        (void)binding_74;
    ...
    }
    {
        ...
        auto volatile binding_75 = &pulp::timebase::project_grid;
        (void)binding_75;
    ...
    }
    {
        ...
        auto volatile binding_76 = &pulp::timebase::OrderPreservingGrooveKernel::create;
        (void)binding_76;
        (void)pulp::timebase::OrderPreservingGrooveKernel::create(pulp::timebase::GrooveKernelInput{});
    }
    {
        // timebase.ratchet
        auto volatile binding_77 = &pulp::timebase::project_ratchet_interval<>;
        (void)binding_77;
    ...
    }
    {
        ...
        auto volatile binding_79 = &pulp::timebase::swing_position;
        (void)binding_79;
        auto volatile binding_80 = &pulp::timebase::unswing_position;
        (void)binding_80;
    ...
    }
    {
        ...
        auto volatile binding_82 = static_cast<pulp::runtime::Result<pulp::timebase::CompiledTempoMap, pulp::timebase::TempoMapError> (*)(std::span<const pulp::timebase::TempoPoint>, pulp::timebase::RationalRate) noexcept>(&pulp::timebase::CompiledTempoMap::compile);
        (void)binding_82;
        auto volatile binding_83 = static_cast<pulp::timebase::SamplePosition (pulp::timebase::CompiledTempoMap::*)(pulp::timebase::TickPosition) const noexcept>(&pulp::timebase::CompiledTempoMap::ticks_to_samples);
        (void)binding_83;
        auto volatile binding_84 = static_cast<pulp::timebase::SampleToTickResult (pulp::timebase::CompiledTempoMap::*)(pulp::timebase::SamplePosition) const noexcept>(&pulp::timebase::CompiledTempoMap::resolve_sample);
        (void)binding_84;
