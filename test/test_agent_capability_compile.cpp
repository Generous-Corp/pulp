...
int main() {
    ...
    }
    {
        ...
        auto volatile binding_88 = static_cast<pulp::signal::MinimumPhaseFirResult (*)(std::span<const double>, const pulp::signal::MinimumPhaseFirOptions&)>(&pulp::signal::reconstruct_minimum_phase_fir);
        (void)binding_88;
    ...
    }
    {
        ...
        auto volatile binding_104 = static_cast<bool (*)(const float*, const float*, float*, float*, std::size_t) noexcept>(&pulp::signal::mid_side_encode_block<float>);
        (void)binding_104;
        auto volatile binding_105 = static_cast<bool (*)(float, std::span<float>) noexcept>(&pulp::signal::nway_constant_power_gains<float>);
        (void)binding_105;
    ...
    }
    {
        ...
        auto volatile binding_117 = static_cast<bool (*)(const pulp::signal::SpectralBandLayoutT<float>&, int, float, pulp::signal::SpectralBandResolutionT<float>&) noexcept>(&pulp::signal::analyze_spectral_band_resolution<float>);
        (void)binding_117;
        auto volatile binding_118 = static_cast<bool (*)(const pulp::signal::SpectralBandLayoutT<float>&, int, float, pulp::signal::SpectralMaskTableT<float>&) noexcept>(&pulp::signal::build_spectral_mask<float>);
        (void)binding_118;
        auto volatile binding_119 = static_cast<bool (*)(std::complex<float>* const*, int, int, const pulp::signal::SpectralMaskTableT<float>&) noexcept>(&pulp::signal::apply_spectral_mask<float>);
        (void)binding_119;
    ...
    }
    {
        ...
        auto volatile binding_148 = &pulp::timebase::division_ticks;
        (void)binding_148;
    ...
    }
    {
        ...
        auto volatile binding_150 = &pulp::timebase::coordinate_chance;
        (void)binding_150;
    ...
    }
    {
        ...
        auto volatile binding_151 = &pulp::timebase::project_grid;
        (void)binding_151;
    ...
    }
    {
        ...
        auto volatile binding_152 = &pulp::timebase::OrderPreservingGrooveKernel::create;
        (void)binding_152;
        (void)pulp::timebase::OrderPreservingGrooveKernel::create(pulp::timebase::GrooveKernelInput{});
    }
    {
        // timebase.ratchet
        auto volatile binding_153 = &pulp::timebase::project_ratchet_interval<>;
        (void)binding_153;
    ...
    }
    {
        ...
        auto volatile binding_155 = &pulp::timebase::swing_position;
        (void)binding_155;
        auto volatile binding_156 = &pulp::timebase::unswing_position;
        (void)binding_156;
    ...
    }
    {
        ...
        auto volatile binding_158 = static_cast<pulp::runtime::Result<pulp::timebase::CompiledTempoMap, pulp::timebase::TempoMapError> (*)(std::span<const pulp::timebase::TempoPoint>, pulp::timebase::RationalRate) noexcept>(&pulp::timebase::CompiledTempoMap::compile);
        (void)binding_158;
        auto volatile binding_159 = static_cast<pulp::timebase::SamplePosition (pulp::timebase::CompiledTempoMap::*)(pulp::timebase::TickPosition) const noexcept>(&pulp::timebase::CompiledTempoMap::ticks_to_samples);
        (void)binding_159;
        auto volatile binding_160 = static_cast<pulp::timebase::SampleToTickResult (pulp::timebase::CompiledTempoMap::*)(pulp::timebase::SamplePosition) const noexcept>(&pulp::timebase::CompiledTempoMap::resolve_sample);
        (void)binding_160;
