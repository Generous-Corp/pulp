...
int main() {
    ...
    {
        // audio.realtime-output-probe
        static_assert(sizeof(pulp::audio::AudioProbe) > 0);
        pulp::audio::AudioProbe probe_value_0{}; (void)probe_value_0.prepare(2, 64, 48000.0);
    }
    {
    ...
    }
    {
        ...
        auto volatile binding_6 = &pulp::audio::VoiceNoteModulationBridge::write;
        (void)binding_6;
    ...
    }
    {
        ...
        auto volatile binding_8 = &pulp::audio::compile_wavetable;
        (void)binding_8;
