...
if(Python3_Interpreter_FOUND)
    ...
    set_tests_properties(rack-fidelity PROPERTIES
        LABELS "rack;patch"
        TIMEOUT 120)
    add_test(NAME rack-acid-taps
        COMMAND ${Python3_EXECUTABLE}
                ${CMAKE_CURRENT_SOURCE_DIR}/../tools/rack/test_acid_taps.py)
    set_tests_properties(rack-acid-taps PROPERTIES
        LABELS "rack;patch"
        TIMEOUT 30)
    add_test(NAME rack-acid-behavior
        COMMAND ${Python3_EXECUTABLE}
                ${CMAKE_CURRENT_SOURCE_DIR}/../tools/rack/test_acid_behavior.py)
    set_tests_properties(rack-acid-behavior PROPERTIES
        LABELS "rack;patch"
        TIMEOUT 30)
endif()
