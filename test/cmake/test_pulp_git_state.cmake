...
pulp_git_tracked_dirty("${_repo}" _clean_dirty)
if(_clean_dirty)
    message(FATAL_ERROR "clean tracked source was reported dirty")
endif()

file(WRITE "${_repo}/configure-input.txt" "untracked\n")
pulp_git_tracked_dirty("${_repo}" _untracked_dirty)
if(_untracked_dirty)
    message(FATAL_ERROR "untracked configure input was reported as tracked dirt")
endif()
...
pulp_git_tracked_dirty("${_repo}" _submodule_untracked_dirty)
if(_submodule_untracked_dirty)
    message(FATAL_ERROR
        "untracked submodule input was reported as tracked source dirt")
endif()

file(WRITE "${_repo}/module/tracked.txt" "dirty\n")
pulp_git_tracked_dirty("${_repo}" _submodule_tracked_dirty)
...
pulp_git_tracked_dirty("${_repo}" _tracked_dirty)
