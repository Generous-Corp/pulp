...
file(WRITE "${_consumer_source}/CMakeLists.txt"
    ...
    "find_package(Pulp REQUIRED COMPONENTS inspect-protocol inspect-discovery inspect-client inspect-runtime inspect-authoring)\n"
    ...
    "  Pulp::inspect-protocol Pulp::inspect-discovery Pulp::inspect-client\n"
    "  Pulp::inspect-runtime Pulp::inspect-authoring)\n")
file(WRITE "${_consumer_source}/main.cpp"
    ...
    "  pulp::inspect::InspectorClientConnectFailure connect_failure;\n"
    "  pulp::inspect::InspectorDiscoveryRecord missing_credential;\n"
    "  const auto connected = client.connect(\n"
    "      missing_credential, discovery, std::chrono::milliseconds(1),\n"
    "      &connect_failure);\n"
    "  pulp::inspect::InspectorClientFailure client_failure;\n"
    "  const auto sessions = pulp::inspect::discover_inspector_sessions(\n"
    "      {.host = \"not-loopback\"}, &client_failure);\n"
    "  pulp::inspect::InspectorServer server;\n"
    "  pulp::inspect::TraceInspector trace;\n"
    "  pulp::inspect::TweakStore tweaks;\n"
    "  (void)discovery.list();\n"
    "  return capability && !connected && !client.is_connected()\n"
    "             && connect_failure.code == \"credential_unavailable\"\n"
    "             && sessions.empty()\n"
    "             && client_failure.code == \"invalid_selector\"\n"
