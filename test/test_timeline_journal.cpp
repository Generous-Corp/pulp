...
TEST_CASE("Serialized checkpoints retain tombstones for replay and exact reactivation") {
    ...
    const std::string valid_tombstone =
        R"({"active":false,"automation_lane_id":"0","clip_id":"5","id":"5","kind":"clip","sequence_id":"3","track_id":"4"})";
    const std::string malformed_tombstone =
        R"({"active":false,"automation_lane_id":"0","clip_id":"0","id":"5","kind":"clip","sequence_id":"3","track_id":"4"})";
    ...
    const std::string orphaned_tombstone =
        R"({"active":false,"automation_lane_id":"0","clip_id":"5","id":"5","kind":"clip","sequence_id":"2","track_id":"4"})";
