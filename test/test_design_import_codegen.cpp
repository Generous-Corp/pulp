...
TEST_CASE("generic HTML generated header is not mislabeled as Claude",
          "[view][import][codegen]") {
    DesignIR ir;
    ...
    REQUIRE(js.find("Generated by Pulp import-design from HTML") !=
            std::string::npos);
    REQUIRE(js.find("Claude Design") == std::string::npos);
}
