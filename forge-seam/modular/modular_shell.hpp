...
public:
    ...
    bool owned_generation_active() const override { return in_flight_; }
    bool owned_generation_replayable() const override;
    bool cancel_owned_generation() override;
    bool retry_owned_generation() override;
    bool edit_owned_generation() override;
    ...
    /// window; an insert puts both on the same track.
