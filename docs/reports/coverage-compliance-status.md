...
Last reviewed: 2026-05-05 20:50 PDT
...
`local/phase3-audio-data-shape-640` at `eac19fe2`, created from current
...
current `origin/main` `42bacd19`, then onto current `origin/main`
`a8c4c16`, then onto current `origin/main` `92e83b37`, covering
AudioFileData helper shape
semantics and WAV writer first-channel-empty rejection. It remains
unpushed and undispatched.
Additional #640 audio progress is queued locally as
`local/phase3-aiff-pcm-edges-640` at `74774950`, created from current
`origin/main` `0447498e`, then refreshed onto current `origin/main`
`8fa55f5e`, then onto current `origin/main` `b7ec8f08`, then onto
current `origin/main` `6c8b9920`, then onto current `origin/main`
`b567dbeb`, then onto current `origin/main` `7e9795b4`, then onto
current `origin/main` `df01f4f6`, then onto current `origin/main`
`42bacd19`, then onto current `origin/main` `a8c4c16`, then onto
current `origin/main` `92e83b37`, covering AIFF
...
`local/phase3-streaming-writer-reopen-640` at `5e1d020d`, created from
...
`7e9795b4`, then onto current `origin/main` `df01f4f6`, then onto
current `origin/main` `42bacd19`, then onto current `origin/main`
`a8c4c16`, then onto current `origin/main` `92e83b37`, covering
StreamingWriter
...
queued locally as
`local/phase3-frame-fill-edges-640` at `8467c68d`, created from current
...
then onto current `origin/main` `a8c4c16`, then onto current
`origin/main` `92e83b37`, covering
...
queued locally as
`local/phase3-audio-tools-model-store-643` at `75ed3a63`, refreshed from
`a88ddfe8` to `9743ccd7`, then onto current `origin/main` `bd036171`,
then onto current `origin/main` `7e9795b4`, then onto current
`origin/main` `df01f4f6`, then onto current `origin/main` `42bacd19`,
then onto current `origin/main` `a8c4c16`, then onto current
`origin/main` `92e83b37`, covering `tools/audio`
...
`local/phase3-platform-environment-dispatch-640` at `33565a65`,
...
`origin/main` `b567dbeb`, then onto current `origin/main` `7e9795b4`,
then onto current `origin/main` `42bacd19`, then onto current
`origin/main` `a8c4c16`, then onto current `origin/main` `92e83b37`,
...
queued locally as
`local/phase3-child-process-read-output-640` at `4c474115`, refreshed
...
`feature/phase3-cli-ship-coverage-643-next` at `384c4d5e`, rebased from
...
`origin/main` `df01f4f6`, then onto current `origin/main` `42bacd19`,
then onto current `origin/main` `a8c4c16`, then onto current
`origin/main` `d191cdca`, then onto current `origin/main` `8a58501b`,
covering `pulp ship sign`
missing-identity guidance in a valid project/build-cache shellout path.
The refreshed branch remains
...
`feature/phase3-cli-audio-command-coverage-643` at `95c6fc6e`, rebased
...
`origin/main` `df01f4f6`, then onto current `origin/main` `42bacd19`,
then onto current `origin/main` `a8c4c16`, then onto current
`origin/main` `d191cdca`, covering deterministic
...
`feature/phase3-named-pipe-coverage-641` at `6fcbcdd1`, rebased from the
...
`a8c4c16`, then current `origin/main` `d191cdca`, then current
`origin/main` `92e83b37`,
...
`feature/phase3-package-commands-coverage-493` at `a7341506`, rebased
from the paused #1273 remote head `c52cd486` onto current `origin/main`
`50ff5822`, then onto current `origin/main` `b7ec8f08`, then
`cf5ea658`, then onto current `origin/main` `24047ba3`, then onto
current `origin/main` `df01f4f6`, then onto current `origin/main`
`a8c4c16`, then onto current `origin/main` `d191cdca`, covering package
target compatibility warnings when an
...
`feature/phase3-design-import-bundle-coverage-493` at `e9669ee9`,
...
then onto current `origin/main` `a8c4c16`, then onto current
`origin/main` `d191cdca`, covering Claude bundle
...
then onto current `origin/main` `df01f4f6`, then onto current
`origin/main` `42bacd19`, then onto current `origin/main` `a8c4c16`,
then onto current `origin/main` `d191cdca`, then onto current
`origin/main` `92e83b37`,
covering `MemoryMappedAudioReader`
unsupported-file fail-closed and EOF no-copy behavior. The refreshed
