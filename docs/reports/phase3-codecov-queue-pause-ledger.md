...
Last updated: 2026-05-04 22:46 PDT
...
Local-only progress at 2026-05-04 16:30 PDT: added
`local/phase3-child-process-read-output-640` at `02c06848`, covering
`ChildProcess::read_available_output()` while a spawned process is
still running. It remains unpushed and undispatched.
...
Additional local-only progress at 2026-05-04 17:15 PDT: added
`local/phase3-validation-harness-json-493` at `15fac4aa`, covering
ValidationHarness report metadata and entry JSON escaping for the #493
format tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 17:22 PDT: added
`local/phase3-signal-graph-guards-493` at `adcf5dcf`, covering
SignalGraph missing-node guards, remove-node connection cleanup, and
default accessors for the #493 host tranche. It remains unpushed and
undispatched.

Additional local-only progress at 2026-05-04 17:37 PDT: added
`local/phase3-widgets-render-paths-493` at `fefb7e94`, covering widget
custom-shader CPU fallbacks, minimal render-style branches, and
knob/fader/toggle interaction edges for the #493 view tranche. It
remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 17:49 PDT: added
`local/phase3-audio-bridge-edges-493` at `255b0516`, covering
AudioBridge first-pop/default meter, max-channel clamp, zero-sample
analysis, and MeterBallistics tiny-value clamp paths for the #493 view
...
Additional local-only progress at 2026-05-04 18:31 PDT: added
...
Additional local-only progress at 2026-05-04 18:50 PDT: added
...
and reset-during-dispatch skip behavior for the #640 platform tranche.
It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 18:59 PDT: added
`local/phase3-midi-ci-edges-645` at `9b7e547f`, covering MIDI-CI
malformed universal/sub-ID guard paths, directly addressed discovery
inquiries, short discovery replies, and reserved-byte profile matching
for the #645 MIDI tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 19:07 PDT: added
`local/phase3-mpe-allocator-edges-645` at `fc198dec`, fixing the
MpeVoiceAllocator release-steal glide refcount path and covering
unmatched MpeGlideDetector note-off/reset behavior for the #645
MIDI/MPE tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 19:20 PDT: added
`local/phase3-host-scanner-order-493` at `c3b79d68`, covering
...
paths for the #493 host tranche. It remains unpushed and undispatched.
...
Additional local-only progress at 2026-05-04 19:53 PDT: added
`local/phase3-ui-components-edges-493` at `33d5f737`, covering ComboBox
...
out-of-range mouse guards for the #493 view tranche. It remains
unpushed and undispatched.

Additional local-only progress at 2026-05-04 20:01 PDT: added
...
scalar value formatting paths for the #493 view/widget tranche. It
remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 20:09 PDT: added
...
Additional local-only progress at 2026-05-04 20:17 PDT: added
...
#493 view tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 20:28 PDT: added
...
RecentlyOpenedFilesList remove/missing-path behavior for the #493 view
code-editor tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 20:36 PDT: added
...
#493 view graph-editor tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 20:43 PDT: added
...
Additional local-only progress at 2026-05-04 20:51 PDT: added
...
Additional local-only progress at 2026-05-04 20:57 PDT: added
`local/phase3-splash-screen-493` at `38f2c93d`, covering SplashScreen
advance/dismiss callback behavior, dismiss-on-click gating, and
text/image paint output for the #493 view tranche. It remains unpushed
and undispatched.

Additional local-only progress at 2026-05-04 21:03 PDT: added
`local/phase3-appearance-manager-493` at `b96abb6b`, covering
...
and unlock behavior for the #493 view appearance-manager tranche. It
remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 21:09 PDT: added
...
paint highlight, and expanded/collapsed disclosure paint output for the
#493 view TreeView tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 21:17 PDT: added
`local/phase3-modal-overlay-edges-493` at `e40432f2`, covering
...
view ModalOverlay tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 21:28 PDT: added
`local/phase3-auto-ui-edges-493` at `485f6cd5`, covering AutoUi
generated toggle state, generated knob display-format branches, and
sync propagation to toggles and existing faders for the #493 view
AutoUi tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 21:34 PDT: added
`local/phase3-image-cache-trim-493` at `1afb279e`, covering
ImageCache byte-budget lowering, least-recently-used trimming, and
releaser behavior for the #493 view ImageCache tranche. It remains
unpushed and undispatched.

Additional local-only progress at 2026-05-04 21:42 PDT: added
...
capture-length clamp paths for the #493 view tranche. It remains
unpushed and undispatched.

Additional local-only progress at 2026-05-04 21:49 PDT: added
...
extension paths for the #493 view tranche. It remains unpushed and
undispatched.

Additional local-only progress at 2026-05-04 21:56 PDT: added
...
view tranche. It remains unpushed and undispatched.
...
2026-05-04 22:46 PDT: rebased/amended
...
rules so harness tests participate in the measured Python tools lane
without transient adapter fixtures being reported as source. It remains
unpushed and undispatched.
...
| `local/phase3-child-process-read-output-640` | `02c06848` | #640 platform tranche for `ChildProcess::read_available_output()` while stdout is available before process completion | `test/test_child_process.cpp` | Created from local `origin/main` at `1fe671df` on 2026-05-04; committed `02c068488161efea6a1957a72876aabd4d727932`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed; `cmake --build build --target pulp-test-child-process -j$(sysctl -n hw.ncpu)` passed with existing platform warnings; focused `./build/test/pulp-test-child-process "read_available_output drains stdout while process is running" -r compact` passed 5 assertions in 1 test case; full `./build/test/pulp-test-child-process -r compact` passed 65 assertions in 21 test cases; `ctest --test-dir build -R "child-process|read_available_output|ChildProcess" --output-on-failure` passed 1/1; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD && git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-platform-environment-dispatch-640` | `49d0611a` | #640 platform tranche for Environment token self-move, listener removal before dispatch, and reset-during-dispatch skip behavior | `test/test_environment.cpp` | Created from local `origin/main` at `b9417b41`, then rebased cleanly onto current `origin/main` at `a6177809` on 2026-05-04; committed `49d0611adf53c1e9f329206c80598f04f67ad34a`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-environment -j$(sysctl -n hw.ncpu)` passed; focused `./build/test/pulp-test-environment "[environment][issue-640]" -r compact` passed 61 assertions in 10 test cases; full `./build/test/pulp-test-environment -r compact` passed 106 assertions in 21 test cases; `ctest --test-dir build -R "Environment|environment|pulp-test-environment" --output-on-failure` passed 21/21; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-midi-ci-edges-645` | `9b7e547f` | #645 MIDI tranche for MIDI-CI malformed header rejection, directly addressed discovery inquiries, short discovery replies, and reserved-byte profile matching | `test/test_midi_ci.cpp` | Created from local `origin/main` at `a6177809` on 2026-05-04; committed `9b7e547f45cc6982889731b95697fbda3ad63950`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-midi-ci -j$(sysctl -n hw.ncpu)` passed; focused `./build/test/pulp-test-midi-ci "[midi][ci][issue-645]" -r compact` passed 54 assertions in 10 test cases; full `./build/test/pulp-test-midi-ci -r compact` passed 81 assertions in 19 test cases; `ctest --test-dir build -R "CiDiscovery|MUID|midi-ci|pulp-test-midi-ci" --output-on-failure` passed 19/19; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-mpe-allocator-edges-645` | `fc198dec` | #645 MIDI/MPE tranche for preserving MpeVoiceAllocator glide refcounts when stealing releasing voices, plus unmatched MpeGlideDetector note-off/reset coverage | `core/midi/include/pulp/midi/mpe_synth_voice.hpp`, `test/test_mpe_synth_voice.cpp` | Created from local `origin/main` at `a6177809` on 2026-05-04; committed `fc198decdadb934e6d919cdf910f6683932d3d1f`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-mpe-synth-voice -j$(sysctl -n hw.ncpu)` passed; focused `./build/test/pulp-test-mpe-synth-voice "[midi][mpe][issue-645]" -r compact` passed 62 assertions in 6 test cases; full `./build/test/pulp-test-mpe-synth-voice -r compact` passed 86 assertions in 14 test cases; `ctest --test-dir build -R "MpeVoiceAllocator|MpeGlideDetector|mpe-synth-voice" --output-on-failure` passed 12/12; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-host-scanner-order-493` | `c3b79d68` | #493 host scanner tranche for PluginScanner VST3/LV2 format-lane merging, final name ordering, LV2 URI identity, VST3 stem fallback identity, and hermetic synthetic scanner fixtures | `test/test_host_regression.cpp` | Created from local `origin/main` at `a6177809`, then rebased onto current `origin/main` at `0cc29fa4` on 2026-05-04; committed `c3b79d681891db91fa85398f22bf1e275617a945`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-host-regression -j$(sysctl -n hw.ncpu)` passed; focused `./build/test/pulp-test-host-regression "PluginScanner merges enabled format lanes and sorts by plugin name" -r compact` passed 10 assertions in 1 test case; tag run `./build/test/pulp-test-host-regression "[host][scanner]" -r compact` passed 61 assertions in 11 test cases without walking installed plugin directories; full `./build/test/pulp-test-host-regression -r compact` passed 430 assertions in 19 test cases; exact `ctest --test-dir build -R "PluginScanner merges enabled format lanes" --output-on-failure` passed 1/1; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
...
| `local/phase3-ui-components-edges-493` | `33d5f737` | #493 view tranche for ComboBox popup handoff/typeahead no-op, ScrollView scrolled-child pointer-event hit testing and paint clipping/visibility, and ListBox boundary-key/out-of-range mouse guards | `test/test_ui_components.cpp` | Created from local `origin/main` at `189255c2`, then rebased cleanly onto current `origin/main` at `69cd68b1` on 2026-05-04; committed `33d5f73765745f0617ca4b2b4b97ef7ac7aa0371`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-ui-components -j$(sysctl -n hw.ncpu)` passed; focused cases `ComboBox opening another popup closes the previous one`, `ScrollView hit testing honors pointer modes with scrolled children`, `ScrollView paint_all clips translated content and skips invisible views`, and `ListBox ignores boundary keys and out-of-range mouse presses` all passed; full `./build/test/pulp-test-ui-components -r compact` passed 147 assertions in 37 test cases; exact `ctest --test-dir build -R "ComboBox opening another popup|ScrollView hit testing honors pointer modes|ScrollView paint_all clips translated content|ListBox ignores boundary keys" --output-on-failure` passed 4/4; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-phase9-widget-edges-493` | `d5000a24` | #493 view/widget tranche for SplitView drag minimum clamps, miss/drag guards, divider grip paint branches, and PropertyList boolean editing, category height/paint, and scalar value formatting paths | `test/test_phase9_widgets.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `d5000a247a20962f2c5a6e9ea8aaa2b6fdd429d9`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-phase9-widgets -j$(sysctl -n hw.ncpu)` passed; focused cases `SplitView drag handling clamps to pane minimums and ignores misses`, `SplitView paint emits horizontal and vertical divider grips`, `PropertyList mouse editing toggles writable booleans only`, and `PropertyList paints categories and scalar value variants` all passed; full `./build/test/pulp-test-phase9-widgets -r compact` passed 161 assertions in 34 test cases; exact `ctest --test-dir build -R "SplitView drag handling|SplitView paint emits|PropertyList mouse editing|PropertyList paints categories" --output-on-failure` passed 4/4; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-gui-components-edges-493` | `30d414ea` | #493 view/gui tranche for TableListBox header sorting, row selection/out-of-range guards, scaled/aligned paint paths, and ConcertinaPanel invalid-index, content visibility/layout, paint, and mouse-hit paths | `test/test_gui_components.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `30d414eab534b3a006f74f5537242e2241277458`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-gui-components -j$(sysctl -n hw.ncpu)` passed; focused cases `TableListBox header sorting and row selection edge paths`, `TableListBox paint covers empty guards scaled columns and alignment`, `ConcertinaPanel guards indices and syncs content visibility`, and `ConcertinaPanel paint and mouse hit testing cover content offsets` all passed; full `./build/test/pulp-test-gui-components -r compact` passed 168 assertions in 31 test cases; exact `ctest --test-dir build -R "TableListBox header sorting|TableListBox paint covers|ConcertinaPanel guards indices|ConcertinaPanel paint and mouse" --output-on-failure` passed 4/4; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-live-constant-editor-493` | `aeae2883` | #493 view tranche for LiveConstantRegistry duplicate registration, clamp, callback, missing-key, reset, and reset-all paths, plus LiveConstantEditor visibility, paint, slider drag, header guard, and missing-row drag paths | `test/CMakeLists.txt`, `test/test_live_constant_editor.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `aeae2883a1b018d81dc789beb87066462863c910`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-live-constant-editor -j$(sysctl -n hw.ncpu)` passed; full `./build/test/pulp-test-live-constant-editor -r compact` passed 26 assertions in 2 test cases; exact `ctest --test-dir build -R "LiveConstantRegistry|LiveConstantEditor|live-constant" --output-on-failure` passed 2/2; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-code-editor-doc-mru-493` | `8595aab3` | #493 view code-editor tranche for FileBasedDocument successful load/save-as dirty-state behavior and RecentlyOpenedFilesList remove/missing-path behavior | `test/test_code_editor.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `8595aab3040f7848182695f8d92d488617b7209c`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-code-editor -j$(sysctl -n hw.ncpu)` passed; focused `./build/test/pulp-test-code-editor "FileBasedDocument handles successful load and save_as paths" -r compact` passed 15 assertions in 1 test case; focused `./build/test/pulp-test-code-editor "RecentlyOpenedFilesList removes entries and ignores missing paths" -r compact` passed 7 assertions in 1 test case; full `./build/test/pulp-test-code-editor -r compact` passed 74 assertions in 13 test cases; exact `ctest --test-dir build -R "FileBasedDocument handles successful|RecentlyOpenedFilesList removes entries" --output-on-failure` passed 2/2; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-graph-editor-paint-493` | `0258cfa4` | #493 view graph-editor tranche for GraphEditorView auto-layout/manual-position preservation, unnamed node/multi-port painting, and feedback/MIDI edge paint colors | `test/test_graph_editor_view.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `0258cfa45c21c1974a92816385baa4e13a38fc92`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-graph-editor-view -j$(sysctl -n hw.ncpu)` passed with existing view warning noise; focused `./build/test/pulp-test-graph-editor-view "GraphEditorView auto layout preserves positions and paints unnamed ports" -r compact` passed 7 assertions in 1 test case; focused `./build/test/pulp-test-graph-editor-view "GraphEditorView paints feedback and midi edge colors" -r compact` passed 4 assertions in 1 test case; full `./build/test/pulp-test-graph-editor-view -r compact` passed 33 assertions in 6 test cases; exact `ctest --test-dir build -R "GraphEditorView auto layout preserves|GraphEditorView paints feedback" --output-on-failure` passed 2/2; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-new-widgets-input-493` | `741caf74` | #493 view/widget tranche for MidiKeyboard vertical drag release/miss behavior, note-name/highlight painting, and FileDropZone rejected-drop reset plus idle/valid/invalid/no-icon paint paths | `test/test_phase9_widgets.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `741caf74983117ac81a7687afeacb675de92fb2e`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-phase9-widgets -j$(sysctl -n hw.ncpu)` passed with existing dependency and view warning noise; focused `./build/test/pulp-test-phase9-widgets "MidiKeyboard vertical drag releases previous notes and misses" -r compact` passed 15 assertions in 1 test case; focused `./build/test/pulp-test-phase9-widgets "MidiKeyboard paint emits note names and active highlight color" -r compact` passed 4 assertions in 1 test case; focused `./build/test/pulp-test-phase9-widgets "FileDropZone rejected drop resets state without callback" -r compact` passed 5 assertions in 1 test case; focused `./build/test/pulp-test-phase9-widgets "FileDropZone paint covers idle valid invalid and no-icon states" -r compact` passed 6 assertions in 1 test case; full `./build/test/pulp-test-phase9-widgets -r compact` passed 155 assertions in 34 test cases; exact `ctest --test-dir build -R "MidiKeyboard vertical drag|MidiKeyboard paint emits|FileDropZone rejected drop|FileDropZone paint covers" --output-on-failure` passed 4/4; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-file-browser-paint-493` | `74dd1dd0` | #493 view/file-browser tranche for FileBrowser sorted-row paint clipping and MultiDocumentPanel active/inactive tab paint output | `test/test_file_browser.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `74dd1dd07bb2b1f5ae3400d85cb61a096f328353`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-file-browser -j$(sysctl -n hw.ncpu)` passed with existing dependency and view warning noise; focused `./build/test/pulp-test-file-browser "FileBrowser paint clips rows after sorted visible entries" -r compact` passed 9 assertions in 1 test case; focused `./build/test/pulp-test-file-browser "MultiDocumentPanel paint emits active and inactive tab labels" -r compact` passed 12 assertions in 1 test case; full `./build/test/pulp-test-file-browser -r compact` passed 81 assertions in 6 test cases; exact `ctest --test-dir build -R "FileBrowser paint clips rows|MultiDocumentPanel paint emits" --output-on-failure` passed 2/2; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-splash-screen-493` | `38f2c93d` | #493 view tranche for SplashScreen advance/dismiss callback behavior, dismiss-on-click gating, and text/image paint output | `test/CMakeLists.txt`, `test/test_splash_screen.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `38f2c93d94492a6a6b57d3ceb09474b0d1c10b17`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-splash-screen -j$(sysctl -n hw.ncpu)` passed with existing dependency and view warning noise; focused `./build/test/pulp-test-splash-screen "SplashScreen advance walks fade hold and dismissal callback" -r compact` passed 14 assertions in 1 test case; focused `./build/test/pulp-test-splash-screen "SplashScreen mouse dismissal respects dismiss-on-click setting" -r compact` passed 8 assertions in 1 test case; focused `./build/test/pulp-test-splash-screen "SplashScreen paint emits loading text or configured image" -r compact` passed 12 assertions in 1 test case; full `./build/test/pulp-test-splash-screen -r compact` passed 34 assertions in 3 test cases; exact `ctest --test-dir build -R "SplashScreen" --output-on-failure` passed 3/3; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-appearance-manager-493` | `b96abb6b` | #493 view appearance-manager tranche for AppearanceTracker repeated lock callbacks/locked poll and ThemeManager locked-theme, locked-appearance callback, and unlock behavior | `test/test_appearance_tracker.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `b96abb6b1154ab236c85c00d9893f7d22640244e`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-appearance -j$(sysctl -n hw.ncpu)` passed; focused `./build/test/pulp-test-appearance "AppearanceTracker callbacks follow repeated locks and locked poll no-op" -r compact` passed 7 assertions in 1 test case; focused `./build/test/pulp-test-appearance "ThemeManager callbacks cover locked theme poll and unlock" -r compact` passed 13 assertions in 1 test case; full `./build/test/pulp-test-appearance -r compact` passed 34 assertions in 10 test cases; exact `ctest --test-dir build -R "AppearanceTracker callbacks follow|ThemeManager callbacks cover" --output-on-failure` passed 2/2; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-tree-view-edges-493` | `76b99bee` | #493 view TreeView tranche for disclosure collapse, left-key consumed-state behavior, selected-row paint highlight, and expanded/collapsed disclosure paint output | `test/test_tree_view.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `76b99bee3cc5b501032ac3b23916736057fb01c2`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-tree-view -j$(sysctl -n hw.ncpu)` passed with existing dependency and view warning noise; focused `./build/test/pulp-test-tree-view "TreeView triangle click toggles without selecting" -r compact` passed 10 assertions in 1 test case; focused `./build/test/pulp-test-tree-view "TreeView key left consumes collapsed selected nodes without toggling" -r compact` passed 3 assertions in 1 test case; focused `./build/test/pulp-test-tree-view "TreeView paint covers selection highlight and disclosure states" -r compact` passed 7 assertions in 1 test case; full `./build/test/pulp-test-tree-view -r compact` passed 53 assertions in 15 test cases; exact `ctest --test-dir build -R "TreeView triangle click|TreeView key left consumes|TreeView paint covers" --output-on-failure` passed 3/3; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-modal-overlay-edges-493` | `e40432f2` | #493 view ModalOverlay tranche for key-release/no-callback Escape behavior, backdrop alpha paint output, and backdrop-click dismissal hit/flag guards | `test/test_modal.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `e40432f280a260251e10018b339820ed072fb455`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-modal -j$(sysctl -n hw.ncpu)` passed with existing dependency and view warning noise; focused `./build/test/pulp-test-modal "ModalOverlay ignores key releases and handles Escape without callback" -r compact` passed 2 assertions in 1 test case; focused `./build/test/pulp-test-modal "ModalOverlay paint applies backdrop alpha to fill color" -r compact` passed 4 assertions in 1 test case; focused `./build/test/pulp-test-modal "ModalOverlay backdrop mouse dismissal respects hit target and flag" -r compact` passed 4 assertions in 1 test case; full `./build/test/pulp-test-modal -r compact` passed 18 assertions in 8 test cases; exact `ctest --test-dir build -R "ModalOverlay ignores key releases|ModalOverlay paint applies|ModalOverlay backdrop mouse dismissal" --output-on-failure` passed 3/3; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-auto-ui-edges-493` | `485f6cd5` | #493 view AutoUi tranche for generated toggle state, generated knob display-format branches, and sync propagation to toggles and existing faders | `test/test_auto_ui.cpp` | Created from current `origin/main` at `69cd68b1` on 2026-05-04; committed `485f6cd59aa06cc1dc5427fa8f16cc635749bd53`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-auto-ui -j$(sysctl -n hw.ncpu)` passed; focused `./build/test/pulp-test-auto-ui "AutoUi generated controls expose toggle state and formatted values" -r compact` passed 10 assertions in 1 test case; focused `./build/test/pulp-test-auto-ui "AutoUi sync updates generated toggles and existing faders" -r compact` passed 6 assertions in 1 test case; full `./build/test/pulp-test-auto-ui -r compact` passed 21 assertions in 4 test cases; exact-ish `ctest --test-dir build -R "AutoUi generated controls|AutoUi sync updates" --output-on-failure` passed 3/3, including the pre-existing sync case matched by the selector; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1, behind 6. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-image-cache-trim-493` | `1afb279e` | #493 view ImageCache tranche for byte-budget lowering, least-recently-used trimming, and releaser behavior | `test/test_image_cache.cpp` | Created from current `origin/main` at `e4001070` on 2026-05-04; committed `1afb279e9d4679f43c4a1e67f6873020e10f28e7`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-image-cache -j$(sysctl -n hw.ncpu)` passed with existing third-party/platform warning noise; focused `./build/test/pulp-test-image-cache "lowering byte budget trims least recently used entries" -r compact` passed 13 assertions in 1 test case; full `./build/test/pulp-test-image-cache -r compact` passed 49 assertions in 9 test cases; exact `ctest --test-dir build -R "lowering byte budget trims|image-cache|ImageCache" --output-on-failure` passed 1/1; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --cached --check`, `git diff --check origin/main...HEAD`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-visualization-bridge-edges-493` | `10405bc2` | #493 view VisualizationBridge tranche for disabled-waveform publication, zero-channel processing, and waveform capture-length clamp paths | `test/test_visualization.cpp` | Created from current `origin/main` at `e4001070` on 2026-05-04; committed `10405bc2bd05af33d0739a1be988b5c5a30a31b2`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-visualization -j$(sysctl -n hw.ncpu)` passed with existing third-party/platform/view warning noise; focused bridge run `./build/test/pulp-test-visualization "[vizbridge]" -r compact` passed 24 assertions in 9 test cases; full `./build/test/pulp-test-visualization -r compact` passed 38 assertions in 15 test cases; exact `ctest --test-dir build -R "VisualizationBridge skips waveform|VisualizationBridge zero-channel|VisualizationBridge clamps waveform" --output-on-failure` passed 3/3; skill-sync and version-bump reports passed or reported no mapped paths touched; `git diff --check`, `git diff --cached --check`, and `git diff --check origin/main...HEAD` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-waveform-editor-edges-493` | `a199b6dc` | #493 view WaveformEditor tranche for selection, visible-range, playhead, paint overlay, key, and mouse edge paths | `test/test_waveform_editor.cpp` | Created from current `origin/main` at `e4001070` on 2026-05-04; committed `a199b6dce63924b697a54411acb4f2f97ccfbfcc`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-waveform-editor -j$(sysctl -n hw.ncpu)` passed with existing third-party/platform/view warning noise; focused `./build/test/pulp-test-waveform-editor "[view][waveform_editor]" -r compact` passed 62 assertions in 20 test cases; full `./build/test/pulp-test-waveform-editor -r compact` passed 62 assertions in 20 test cases; exact `ctest --test-dir build -R "WaveformEditor clamps selection|WaveformEditor zoom to selection is a no-op|WaveformEditor visible range clamps|WaveformEditor playhead clamps|WaveformEditor paint records|WaveformEditor key scrolls|WaveformEditor mouse click" --output-on-failure` passed 7/7; skill-sync and version-bump reports passed or reported no mapped paths touched; `git diff --check`, `git diff --cached --check`, and `git diff --check origin/main...HEAD` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-window-manager-edges-493` | `5d62f37a` | #493 view WindowManager tranche for unregister callback/missing-id cleanup, null host/root close behavior, and missing-handler send/broadcast paths | `test/test_window_manager.cpp` | Created from current `origin/main` at `e4001070` on 2026-05-04; committed `5d62f37a915091449d613cd7b59631bc6ab64486`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-window-manager -j$(sysctl -n hw.ncpu)` passed with existing third-party/platform/view warning noise; focused `./build/test/pulp-test-window-manager "[view][multiwindow]" -r compact` passed 82 assertions in 21 test cases; full `./build/test/pulp-test-window-manager -r compact` passed 82 assertions in 21 test cases; exact `ctest --test-dir build -R "WindowManager unregister invokes|WindowManager closes windows without|WindowManager send and broadcast skip" --output-on-failure` passed 3/3; skill-sync and version-bump reports passed or reported no mapped paths touched; `git diff --check`, `git diff --cached --check`, and `git diff --check origin/main...HEAD` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
...
| `local/phase3-harness-verifier-643` | `bdb9cd42` | #643 tools tranche for `tools/harness` status/verifier helper coverage, stale yoga auto-discovery baseline refresh, adapter unit-test coverage discovery, and Python coverage-runner source/omit rules for harness tests | `docs/guides/coverage.md`, `tools/harness/tests/test_auto_discover.py`, `tools/harness/tests/test_verifier_status.py`, `tools/scripts/run_python_coverage.py`, `tools/scripts/test_run_python_coverage.py`, `tools/scripts/test_run_python_coverage_extra.py` | Rebased/amended from `51c0c8bf` onto current `origin/main` at `f58b18e0` on 2026-05-04; committed `bdb9cd42b815f141d4f231e80a1af5d6cc7798cf`. `python3 -m unittest discover -s tools/harness/tests -p 'test_*.py'` passed 19 tests; `python3 -m unittest discover -s test/harness -p 'test_*.py'` passed 87 tests; `python3 tools/scripts/test_run_python_coverage.py` passed 24 tests; `python3 tools/scripts/test_run_python_coverage_extra.py` passed 8 tests. Venv-backed `/Users/danielraffel/Code/pulp-check-format-validation-coverage-643/build-coverage/python-venv/bin/python tools/scripts/run_python_coverage.py --pattern tools/harness/tests/test_auto_discover.py --pattern tools/harness/tests/test_verifier_status.py --pattern test/harness/test_canvas2d_adapter.py --pattern test/harness/test_css_adapter.py --pattern test/harness/test_html_adapter.py --pattern test/harness/test_yoga_adapter.py --pattern tools/scripts/test_run_python_coverage.py --pattern tools/scripts/test_run_python_coverage_extra.py` passed; focused report included `tools/harness/adapters/base.py` 93%, `tools/harness/adapters/canvas2d.py` 77%, `tools/harness/adapters/css.py` 89%, `tools/harness/adapters/html.py` 73%, `tools/harness/adapters/yoga.py` 89%, `tools/harness/status.py` 97%, `tools/harness/verifier.py` 90%, and `tools/scripts/run_python_coverage.py` 100% with the expected broad-tools inventory total of 8%. `tools/check-docs.sh` passed with the existing warning set; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD`, `git diff --check`, and `git diff --cached --check` passed; generated coverage/html and `__pycache__` outputs were cleaned; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-audio-focus-dispatch-640` | `3c36343d` | #640 audio tranche for AudioFocusRegistry inactive-listener skip behavior when a listener is removed or reset clears the registry during dispatch | `core/audio/include/pulp/audio/audio_focus.hpp`, `core/audio/src/audio_focus.cpp`, `test/test_audio_focus.cpp` | Created from local `origin/main` at `b9417b41` on 2026-05-04; committed `3c36343de119ba66368f03101450dfb36896f081`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping, third-party, and platform warnings; `cmake --build build --target pulp-test-audio-focus -j$(sysctl -n hw.ncpu)` passed with existing third-party/platform warnings; focused `./build/test/pulp-test-audio-focus "AudioFocusRegistry: listener removed mid-dispatch is skipped" -r compact` passed 7 assertions in 1 test case; focused `./build/test/pulp-test-audio-focus "AudioFocusRegistry: reset during dispatch clears later callbacks" -r compact` passed 3 assertions in 1 test case; tag run `./build/test/pulp-test-audio-focus "[audio][focus][issue-640]" -r compact` passed 20 assertions in 6 test cases; full `./build/test/pulp-test-audio-focus -r compact` passed 44 assertions in 16 test cases; `ctest --test-dir build -R "AudioFocusRegistry|audio-focus|pulp-test-audio-focus" --output-on-failure` passed 16/16; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD`, `git diff --check origin/main`, and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
...
| `local/phase3-validation-harness-json-493` | `15fac4aa` | #493 format tranche for ValidationHarness report metadata and entry JSON escaping | `test/test_validation_harness.cpp` | Created from local `origin/main` at `9e69d472` on 2026-05-04; committed `15fac4aa2a445110e17fb0dd83935bc75d5250d3`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping and third-party warnings; `cmake --build build --target pulp-test-validation-harness -j$(sysctl -n hw.ncpu)` passed; focused `./build/test/pulp-test-validation-harness "ValidationHarness escapes report metadata and entry strings" -r compact` passed 5 assertions in 1 test case; full `./build/test/pulp-test-validation-harness -r compact` passed 218 assertions in 28 test cases; exact `ctest --test-dir build -R "ValidationHarness escapes report metadata and entry strings" --output-on-failure` passed 1/1; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-signal-graph-guards-493` | `adcf5dcf` | #493 host tranche for SignalGraph missing-node guard paths, remove-node connection cleanup, and default accessors | `test/test_host.cpp` | Created from local `origin/main` at `9e69d472` on 2026-05-04; committed `adcf5dcf03f6995e62eafc7c8330f083ffc60f46`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping and third-party warnings; `cmake --build build --target pulp-test-host -j$(sysctl -n hw.ncpu)` passed with existing third-party and test TU warnings; focused `./build/test/pulp-test-host "SignalGraph remove_node drops related connections" -r compact` passed 10 assertions in 1 test case; focused `./build/test/pulp-test-host "SignalGraph guard paths reject missing nodes and keep defaults" -r compact` passed 12 assertions in 1 test case; tag run `./build/test/pulp-test-host "[host][graph]" -r compact` passed 1018 assertions in 18 test cases; full `./build/test/pulp-test-host -r compact` passed 1056 assertions in 29 test cases with existing local plugin scan warnings; exact `ctest --test-dir build -R "SignalGraph remove_node drops related connections|SignalGraph guard paths reject missing nodes and keep defaults" --output-on-failure` passed 2/2; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-widgets-render-paths-493` | `fefb7e94` | #493 view tranche for widget custom-shader CPU fallbacks, minimal render-style branches, and knob/fader/toggle interaction edges | `test/test_widgets.cpp` | Created from local `origin/main` at `b9417b41` on 2026-05-04 after confirming the frozen `feature/view-widget-coverage-493-next` branch had already been absorbed upstream; committed `fefb7e943fda8bca2b3ca8e4f85056dd72e86081`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping and third-party warnings; `cmake --build build --target pulp-test-widgets -j$(sysctl -n hw.ncpu)` passed with existing third-party/platform warnings; focused `./build/test/pulp-test-widgets "[issue-493]" -r compact` passed 34 assertions in 4 test cases; full `./build/test/pulp-test-widgets -r compact` passed 293 assertions in 67 test cases; exact `ctest --test-dir build -R "Audio widgets custom shader paths fall back on recording canvas|Audio widgets minimal render style paints simplified branches|Knob mouse paths update value|Fader and toggle mouse paths dispatch clamped interactive values" --output-on-failure` passed 4/4; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
| `local/phase3-audio-bridge-edges-493` | `255b0516` | #493 view tranche for AudioBridge first-pop/default meter, max-channel clamp, zero-sample analysis, and MeterBallistics tiny-value clamp paths | `test/test_audio_bridge.cpp` | Created from local `origin/main` at `b9417b41` on 2026-05-04; committed `255b051661bfb717d19bea21dc71527392a085ea`. `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar` passed with existing text-shaping and third-party/macOS warnings; `cmake --build build --target pulp-test-audio-bridge -j$(sysctl -n hw.ncpu)` passed with existing third-party/platform warnings; focused `./build/test/pulp-test-audio-bridge "[issue-493]" -r compact` passed 40 assertions in 3 test cases; full `./build/test/pulp-test-audio-bridge -r compact` passed 63 assertions in 8 test cases; exact `ctest --test-dir build -R "AudioBridge pop_latest reports empty before first meter|AudioBridge analyze clamps channels and handles zero sample blocks|MeterBallistics releases tiny values to exact zero" --output-on-failure` passed 3/3; skill-sync, version-bump, docs-sync, and compat-sync reports passed or reported no mapped paths touched; `git diff --check origin/main...HEAD` and `git diff --check` passed; final status clean and ahead 1. | Hold local-only while Namespace is intentionally paused; when capacity returns, rename/push as a feature branch and run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` in a small resume batch. |
