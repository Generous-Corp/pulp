...
Last updated: 2026-05-05 00:31 PDT
...
2026-05-04 23:19 PDT: rebased/amended
`local/phase3-child-process-read-output-640` from `02c06848` to
`55c46d02`, covering `ChildProcess::read_available_output()` while a
spawned process is still running, and rebased/amended
`local/phase3-audio-focus-dispatch-640` from `3c36343d` to
`1ab6e24b`, covering AudioFocusRegistry inactive-listener skip behavior
when a listener is removed or the registry is reset during dispatch,
and rebased `local/phase3-platform-environment-dispatch-640` from
`49d0611a` to `b271d2e6`, covering Environment token self-move,
listener removal before dispatch, and reset-during-dispatch skip
behavior. All three remain unpushed and undispatched.

Additional local-only progress at 2026-05-04 16:37 PDT: refreshed
`feature/phase3-sdl3-surface-fallback-646` to `908b3a49`, covering
SDL3 native-surface fallback/null-window behavior. It has no remote
branch ref and remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 16:50 PDT: added
`local/phase3-cli-config-command-643` at `af1ef6f8`, covering
`pulp config` set/get/list and invalid-key shellout behavior against an
isolated `PULP_HOME`. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 17:03 PDT: added
`local/phase3-linkwitz-riley-edges-645` at `385c51a7`, covering
...
Additional local-only progress at 2026-05-04 23:34 PDT: refreshed
`local/phase3-validation-harness-json-493` from `15fac4aa` to
`974cf572`, covering ValidationHarness report metadata and entry JSON
escaping for the #493 format tranche on current `origin/main`. It
remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 23:37 PDT: refreshed
`local/phase3-signal-graph-guards-493` from `adcf5dcf` to
`247be833`, covering SignalGraph missing-node guards, remove-node
...
Additional local-only progress at 2026-05-04 23:39 PDT: refreshed
`local/phase3-widgets-render-paths-493` from `fefb7e94` to `55a90f79`,
covering widget custom-shader CPU fallbacks, minimal render-style
...
Additional local-only progress at 2026-05-04 23:41 PDT: refreshed
`local/phase3-audio-bridge-edges-493` from `255b0516` to `cba288df`,
covering AudioBridge first-pop/default meter, max-channel clamp,
...
Additional local-only progress at 2026-05-04 18:04 PDT: added
...
Additional local-only progress at 2026-05-04 18:09 PDT: added
...
Additional local-only progress at 2026-05-04 18:17 PDT: added
...
Additional local-only progress at 2026-05-04 18:21 PDT: added
`local/phase3-oscillator-edges-645` at `8f51cba4`, covering
...
2026-05-04 23:17 PDT: rebased/amended
`local/phase3-audio-focus-dispatch-640` from `3c36343d` to
`1ab6e24b`, covering AudioFocusRegistry inactive-listener skip behavior
when a listener is removed or the registry is reset during dispatch for
the #640 audio tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 18:42 PDT: added
...
guard and unsupported-input paths for the #643 tools tranche. It
remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 18:50 PDT, refreshed at
2026-05-04 23:19 PDT: rebased
`local/phase3-platform-environment-dispatch-640` from `49d0611a` to
`b271d2e6`, covering Environment token self-move, listener removal
before dispatch, and reset-during-dispatch skip behavior for the #640
platform tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 18:59 PDT, refreshed at
2026-05-04 23:23 PDT: rebased `local/phase3-midi-ci-edges-645` from
`9b7e547f` to `c3f7e68b`, covering MIDI-CI malformed universal/sub-ID
guard paths, directly addressed discovery inquiries, short discovery
replies, and reserved-byte profile matching for the #645 MIDI tranche.
It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 19:07 PDT, refreshed at
2026-05-04 23:27 PDT: rebased/amended
`local/phase3-mpe-allocator-edges-645` from `fc198dec` to `83ce06b3`,
fixing the MpeVoiceAllocator release-steal glide refcount path,
documenting the releasing-steal invariant in the MPE skill, and
covering unmatched MpeGlideDetector note-off/reset behavior for the
#645 MIDI/MPE tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 19:20 PDT, refreshed at
2026-05-04 23:30 PDT: rebased `local/phase3-host-scanner-order-493`
from `c3b79d68` to `97d9f833`, covering PluginScanner VST3/LV2
format-lane merging, final name ordering, LV2 URI identity, VST3 stem
fallback identity, and hermetic scanner fixture paths for the #493 host
tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 19:32 PDT: added
...
symlink removal without deleting targets for the #643 CLI/tools
tranche. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 23:44 PDT: refreshed
`local/phase3-ui-components-edges-493` from `33d5f737` to `16cc8df1`,
...
and ListBox boundary-key and out-of-range mouse guards for the #493 view
tranche on current `origin/main`. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 23:47 PDT: refreshed
`local/phase3-phase9-widget-edges-493` from `d5000a24` to `d9ffd85b`,
covering SplitView drag minimum clamps, miss/drag guards, divider grip
paint branches, and PropertyList boolean editing, category height/paint,
and scalar value formatting paths for the #493 view/widget tranche on
current `origin/main`. It remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 23:49 PDT: refreshed
`local/phase3-gui-components-edges-493` from `30d414ea` to `b26a0e5f`,
covering TableListBox header sorting, selection and out-of-range row
guards, scaled/aligned painting, and ConcertinaPanel invalid-index,
content visibility/layout, paint, and mouse hit paths for the #493
view/gui tranche on current `origin/main`. It remains unpushed and
undispatched.

Additional local-only progress at 2026-05-04 23:52 PDT: refreshed
`local/phase3-live-constant-editor-493` from `aeae2883` to `0e4a677e`,
covering LiveConstantRegistry duplicate registration, clamp, callback,
missing key, reset, and reset-all paths, plus LiveConstantEditor
visibility, paint, slider drag, header guard, and missing-row drag paths
for the #493 view tranche on current `origin/main`. It remains unpushed
and undispatched.

Additional local-only progress at 2026-05-04 23:54 PDT: refreshed
`local/phase3-code-editor-doc-mru-493` from `8595aab3` to `c97574e6`,
covering FileBasedDocument successful load/save-as dirty-state behavior
and RecentlyOpenedFilesList remove/missing-path behavior for the #493
view code-editor tranche on current `origin/main`. It remains unpushed
and undispatched.

Additional local-only progress at 2026-05-04 20:36 PDT, refreshed at
2026-05-04 23:59 PDT: rebased `local/phase3-graph-editor-paint-493`
from `0258cfa4` to `31d8d7cc`, covering GraphEditorView
...
2026-05-05 00:02 PDT: rebased `local/phase3-new-widgets-input-493`
from `741caf74` to `251cfa5d`, covering MidiKeyboard vertical drag
...
2026-05-05 00:04 PDT: rebased `local/phase3-file-browser-paint-493`
from `74dd1dd0` to `74bc4483`, covering FileBrowser sorted-row paint
...
2026-05-05 00:06 PDT: rebased `local/phase3-splash-screen-493` from
`38f2c93d` to `0e7ebab3`, covering SplashScreen advance/dismiss
...
2026-05-05 00:09 PDT: rebased `local/phase3-appearance-manager-493`
from `b96abb6b` to `31d4e8ff`, covering AppearanceTracker repeated lock
...
2026-05-05 00:12 PDT: rebased `local/phase3-tree-view-edges-493` from
`76b99bee` to `dc87d5fe`, covering TreeView disclosure collapse,
...
2026-05-05 00:16 PDT: rebased `local/phase3-modal-overlay-edges-493`
from `e40432f2` to `0f30dc7a`, covering ModalOverlay
...
2026-05-05 00:19 PDT: rebased `local/phase3-auto-ui-edges-493` from
`485f6cd5` to `545493ad`, covering AutoUi generated toggle state,
...
2026-05-05 00:21 PDT: rebased `local/phase3-image-cache-trim-493` from
`1afb279e` to `312a008f`, covering ImageCache byte-budget lowering,
...
2026-05-05 00:25 PDT: rebased
`local/phase3-visualization-bridge-edges-493` from `10405bc2` to
`dc41a698`, covering VisualizationBridge disabled-waveform,
...
2026-05-05 00:28 PDT: rebased
`local/phase3-waveform-editor-edges-493` from `a199b6dc` to
`9e28c887`, covering WaveformEditor selection, visible-range, and
...
2026-05-05 00:31 PDT: rebased
`local/phase3-window-manager-edges-493` from `5d62f37a` to `7fd5052a`,
covering WindowManager unregister callback/missing-id cleanup, null
host/root close behavior, and missing-handler send/broadcast paths for
the #493 view tranche on current `origin/main`. It remains unpushed and
undispatched.

Additional local-only progress at 2026-05-04 22:02 PDT: added
`local/phase3-param-attachment-edges-493` at `0d6600ec`, covering
ParamAttachment fader/toggle/combo callback forwarding, missing
parameter-id no-op behavior, and `poll_bindings()` external-change
propagation for the #493 view tranche. It remains unpushed and
undispatched.

Additional local-only progress at 2026-05-04 22:08 PDT: added
...
pointer-capture release behavior for the #493 view tranche. It remains
unpushed and undispatched.

Additional local-only progress at 2026-05-04 22:16 PDT: added
...
`getLayoutRect("")` registration fix for the #493 view tranche. It
remains unpushed and undispatched.

Additional local-only progress at 2026-05-04 22:34 PDT, refreshed at
2026-05-04 22:46 PDT and 2026-05-04 23:04 PDT: rebased/amended
`local/phase3-harness-verifier-643` from `51c0c8bf` to `bdb9cd42`,
then to `7b7cc19d`,
covering `tools/harness` status/verifier helper paths, the stale yoga
...
- Local-only progress: `pulp-ruleset-drift-config-643` refreshed again on
  2026-05-04 at `390b68f9`; keep it behind measured-source tranches because it is a
  static guard/test-file-only tranche.
