...
Last updated: 2026-05-05 00:41 PDT
...
2026-05-05 00:41 PDT: rebased/amended
`local/phase3-widget-bridge-dom-493` from `40629315` to `df183299`,
covering WidgetBridge native DOM subtree moves, recursive DOM removal
widget-map cleanup, root/missing layout helper paths, and the root-aware
