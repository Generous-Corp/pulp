...
| --- | --- | --- | --- |
| `local/phase3-local-ci-extra-643` | `/Users/danielraffel/Code/pulp-local-ci-extra-643` | improve `tools/local-ci/local_ci.py` focused coverage via `tools/local-ci/test_local_ci_extra.py` | refreshed locally at `b3236d94dee3`; focused coverage now reports 75%; no push/CI |
...
| `local/phase3-compat-sync-extra-643` | `/Users/danielraffel/Code/pulp-compat-sync-extra-643` | improve `tools/scripts/compat_sync_check.py` focused coverage via `tools/scripts/test_compat_sync_check_extra.py` | refreshed locally at `b3020b2b7e0f`; focused coverage now reports 97%; no push/CI |
...
| --- | --- | --- | --- | --- | --- |
| `local/phase3-docs-generate-coverage-643` | `7a582ae4` | #643 tooling tranche for `tools/docs_generate.py` paths | `tools/scripts/test_docs_generate.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_docs_generate.py` reports 13 tests; `python3 tools/docs_generate.py check` reports `docs-generate: OK`; temp-venv focused `run_python_coverage.py --pattern 'tools/scripts/test_docs_generate.py'` passed 13 tests and reported 97% for `tools/docs_generate.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-list-limitations-coverage-643` | `a77a5b99` | #643 tooling tranche for `tools/list_limitations.py` paths | `tools/scripts/test_list_limitations.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_list_limitations.py` reports 8 tests; `python3 tools/test_list_limitations.py` reports 6 tests; `python3 tools/list_limitations.py` rendered 21 items across 13 capabilities; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_list_limitations.py` passed 8 tests and reported 98% for `tools/list_limitations.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-check-format-validation-coverage-643` | `e95414dc` | #643 tooling tranche for `tools/check_format_validation.py` paths | `tools/scripts/test_check_format_validation.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_check_format_validation.py` reports 9 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_check_format_validation.py` passed and reported 97% for `tools/check_format_validation.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-bench-diff-coverage-643` | `c65c97ca` | #643 tooling tranche for `tools/scripts/bench_diff.py` paths | `tools/scripts/test_bench_diff.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_bench_diff.py` reports 8 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_bench_diff.py` passed 8 tests and reported 98% for `tools/scripts/bench_diff.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-check-docs-consistency-coverage-643` | `0d2c0515` | #643 tooling tranche for `tools/check-docs-consistency.py` paths | `tools/scripts/test_check_docs_consistency.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_check_docs_consistency.py` reports 9 tests; `python3 tools/test_check_docs_consistency.py` reports 9 tests; `python3 tools/check-docs-consistency.py` checked 5 accessibility platforms and 150 statuses; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_check_docs_consistency.py` passed 9 tests and reported 98% for `tools/check-docs-consistency.py`; skill-sync report; version-bump report; `git diff --check`; `git diff --check origin/main..HEAD`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-mkdocs-hooks-coverage-643` | `84dcf913` | #643 tooling tranche for `tools/mkdocs_hooks.py` paths | `tools/scripts/test_mkdocs_hooks.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_mkdocs_hooks.py` reports 6 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_mkdocs_hooks.py` passed 6 tests and reported 96% for `tools/mkdocs_hooks.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-encode-binary-data-coverage-643` | `24f0cd57` | #643 tooling tranche for `tools/cmake/scripts/encode_binary_data.py` paths | `tools/scripts/test_encode_binary_data.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_encode_binary_data.py` reports 5 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_encode_binary_data.py` passed 5 tests and reported 96% for `tools/cmake/scripts/encode_binary_data.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-add-component-coverage-643` | `fdc82d93` | #643 tooling tranche for `tools/add-component.py` paths | `tools/scripts/test_add_component.py` | Confirmed already current with `origin/main`; `python3 tools/scripts/test_add_component.py` reports 8 tests; `python3 tools/scripts/test_gates.py` reports 39 tests; temp-venv coverage over `tools/scripts/test_add_component.py` passed and reported 98% for `tools/add-component.py`; skill-sync report; version-bump report; `git diff --check`; `git diff --check origin/main...HEAD`; final status clean. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-audit-top-level-coverage-643` | `e9c0a82c` | #643 tooling tranche for `tools/audit.py` paths | `tools/scripts/test_audit_top_level.py` | Refreshed against current `origin/main`; `python3 tools/scripts/test_audit_top_level.py` reports 9 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_audit_top_level.py` passed and reported 100% for `tools/audit.py`; skill-sync report; version-bump report; `git diff --check origin/main...HEAD`; final status clean. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. Pip printed cache deserialization warnings during install, but validation passed. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
...
| `local/phase3-embed-js-coverage-643` | `53e73f61` | #643 tooling tranche for `core/view/js/embed_js.py` paths | `tools/scripts/test_embed_js.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_embed_js.py` reports 6 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_embed_js.py` passed and reported 100% for `core/view/js/embed_js.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-run-swift-coverage-extra-643` | `cd227176` | #643 tooling tranche for `tools/scripts/run_swift_coverage.py` paths | `tools/scripts/test_run_swift_coverage_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_run_swift_coverage_extra.py` reports 9 tests; `python3 tools/scripts/test_run_swift_coverage.py` reports 5 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py` over both Swift coverage test files passed and reported 96% for `tools/scripts/run_swift_coverage.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-android-target-coverage-643` | `d82cc55f` | #643 tooling tranche for `tools/local-ci/android_target.py` paths | `tools/scripts/test_android_target.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_android_target.py` reports 16 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_android_target.py` passed 16 tests and reported 100% for `tools/local-ci/android_target.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-validate-hosts-coverage-643` | `c93599bd` | #643 tooling tranche for `tools/deps/validate_hosts.py` paths | `tools/scripts/test_validate_hosts.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_validate_hosts.py` reports 9 tests and only mocked/local commands; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_validate_hosts.py` passed and reported 100% for `tools/deps/validate_hosts.py`; skill-sync report; version-bump report; `git diff --check`. No SSH, VM, or remote validation work was run; system `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-compat-sync-extra-643` | `b3020b2b` | #643 tooling tranche for `tools/scripts/compat_sync_check.py` paths | `tools/scripts/test_compat_sync_check_extra.py` | Refreshed against current `origin/main`; `python3 tools/scripts/test_compat_sync_check.py` reports 30 tests; `python3 tools/scripts/test_compat_sync_check_extra.py` reports 26 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_compat_sync_check.py --pattern tools/scripts/test_compat_sync_check_extra.py` passed and reported 97% for `tools/scripts/compat_sync_check.py`; skill-sync report; version-bump report; `python3 tools/scripts/compat_sync_check.py --base origin/main --mode=report --enforce`; `git diff --check origin/main...HEAD`; final status clean. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-build-migration-index-extra-643` | `416a2156` | #643 tooling tranche for `tools/scripts/build_migration_index.py` paths | `tools/scripts/test_build_migration_index_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_build_migration_index.py` reports 7 tests; `python3 tools/scripts/test_build_migration_index_extra.py` reports 9 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_build_migration_index.py --pattern tools/scripts/test_build_migration_index_extra.py` passed and reported 100% for `tools/scripts/build_migration_index.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-docs-sync-check-extra-643` | `efc950ce` | #643 tooling tranche for `tools/scripts/docs_sync_check.py` paths | `tools/scripts/test_docs_sync_check_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_docs_sync_check.py` reports 15 tests; `python3 tools/scripts/test_docs_sync_check_extra.py` reports 12 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_docs_sync_check.py --pattern tools/scripts/test_docs_sync_check_extra.py` passed and reported 99% for `tools/scripts/docs_sync_check.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-coverage-tier-check-extra-643` | `4504dd6e` | #643 tooling tranche for `tools/scripts/coverage_tier_check.py` paths | `tools/scripts/test_coverage_tier_check_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_coverage_tier_check.py` reports 15 tests; `python3 tools/scripts/test_coverage_tier_check_extra.py` reports 17 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_coverage_tier_check.py --pattern tools/scripts/test_coverage_tier_check_extra.py` passed with `PyYAML` installed and reported 100% for `tools/scripts/coverage_tier_check.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-skill-sync-extra-643` | `776e903e` | #643 tooling tranche for `tools/scripts/skill_sync_check.py` paths | `tools/scripts/test_skill_sync_check_extra.py` | Refreshed against current `origin/main`; `python3 -m unittest tools/scripts/test_skill_sync_check.py tools/scripts/test_skill_sync_check_extra.py` reports 15 tests; temp-venv coverage over the same tests passed and reported 97% for `tools/scripts/skill_sync_check.py`; skill-sync report; version-bump report; `git diff --check`; final status clean. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
...
| `local/phase3-resolve-runs-on-extra-643` | `3e4d65d9` | #643 tooling tranche for `tools/scripts/resolve_runs_on.py` edges | `tools/scripts/test_resolve_runs_on_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_resolve_runs_on.py` reports 18 tests; `python3 tools/scripts/test_resolve_runs_on_extra.py` reports 2 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_resolve_runs_on.py --pattern tools/scripts/test_resolve_runs_on_extra.py` passed and reported 100% for `tools/scripts/resolve_runs_on.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-merge-cobertura-extra-643` | `ecb80b38` | #643 tooling tranche for `tools/scripts/merge_cobertura.py` edges | `tools/scripts/test_merge_cobertura_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_merge_cobertura.py` reports 14 tests; `python3 tools/scripts/test_merge_cobertura_extra.py` reports 3 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_merge_cobertura.py --pattern tools/scripts/test_merge_cobertura_extra.py` passed and reported 100% for `tools/scripts/merge_cobertura.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-lcov-cobertura-extra-643` | `944bf7a9` | #643 tooling tranche for `tools/scripts/lcov_cobertura.py` edges | `tools/scripts/test_lcov_cobertura_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_lcov_cobertura.py` reports 3 tests; `python3 tools/scripts/test_lcov_cobertura_extra.py` reports 7 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_lcov_cobertura.py --pattern tools/scripts/test_lcov_cobertura_extra.py` passed and reported 98% for `tools/scripts/lcov_cobertura.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-run-python-coverage-extra-643` | `f06a6795` | #643 tooling tranche for `tools/scripts/run_python_coverage.py` edges | `tools/scripts/test_run_python_coverage_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; `python3 tools/scripts/test_run_python_coverage_extra.py` reports 7 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_run_python_coverage.py --pattern tools/scripts/test_run_python_coverage_extra.py` passed and reported 99% for `tools/scripts/run_python_coverage.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the focused run used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-cli-sync-check-extra-643` | `1e4aa2c9` | #643 tooling tranche for `tools/scripts/cli_sync_check.py` edges | `tools/scripts/test_cli_sync_check_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_cli_sync_check.py` reports 7 tests; `python3 tools/scripts/test_cli_sync_check_extra.py` reports 6 tests; `python3 tools/scripts/test_run_python_coverage.py` reports 23 tests; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_cli_sync_check.py --pattern tools/scripts/test_cli_sync_check_extra.py` passed and reported 98% for `tools/scripts/cli_sync_check.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-local-ci-extra-643` | `b3236d94` | #643 tooling tranche for `tools/local-ci/local_ci.py` helper edges | `tools/local-ci/test_local_ci.py`, `tools/local-ci/test_local_ci_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 -m unittest tools/local-ci/test_local_ci.py tools/local-ci/test_local_ci_extra.py` reports 227 tests; temp-venv coverage over both test files passed and reported 75% for `tools/local-ci/local_ci.py`; skill-sync report accepted the test-only local-ci bypass; version-bump report; `git diff --check`; final status clean. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-deps-audit-extra-643` | `2c0bb0b2` | #643 tooling tranche for `tools/deps/audit.py` edges | `tools/deps/test_audit_extra.py` | Refreshed against current `origin/main`; `python3 tools/deps/test_audit.py` reports 10 tests; `python3 tools/deps/test_audit_extra.py` reports 12 tests; `python3 tools/deps/audit.py --strict` passed; temp-venv focused `run_python_coverage.py --pattern tools/deps/test_audit.py --pattern tools/deps/test_audit_extra.py` passed and reported 99% for `tools/deps/audit.py`; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
...
| `local/phase3-freshness-extra-643` | `10561667` | #643 tooling tranche for `tools/packages/freshness_check.py` edges plus shared coverage-runner behavior needed by this tranche | `tools/packages/test_freshness_check_extra.py`, `tools/scripts/run_python_coverage.py`, `tools/scripts/test_run_python_coverage.py` | Refreshed against current `origin/main`; `python3 tools/packages/test_freshness_check_extra.py` reports 7 tests; `python3 tools/packages/test_package_validation_tools.py` reports 14 tests with the existing expected `jsonschema not installed` skip-path warning; temp-venv focused `run_python_coverage.py --pattern tools/packages/test_freshness_check_extra.py` passed and reported 78% for `tools/packages/freshness_check.py`; `python3 tools/scripts/test_run_python_coverage.py` reports 24 tests; skill-sync report with package skip trailer; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
...
| `local/phase3-validate-registry-extra-643` | `70f19e6c` | #643 tooling tranche for `tools/packages/validate_registry.py` edges | `tools/scripts/test_validate_registry_extra.py` | Refreshed against current `origin/main` at `7b78de80`; `python3 tools/scripts/test_validate_registry_extra.py`; `python3 tools/packages/test_package_validation_tools.py`; `python3 tools/scripts/test_package_cli.py`; `python3 tools/scripts/test_run_python_coverage.py`; temp-venv focused `run_python_coverage.py --pattern tools/scripts/test_validate_registry_extra.py --pattern tools/scripts/test_package_cli.py --pattern tools/packages/test_package_validation_tools.py` passed and covered the validate-registry/package CLI tranche; skill-sync report; version-bump report; `git diff --check`. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-workflow-lint-coverage-643` | `3ddb1b5a` | #643 static workflow guard tranche for `.github/workflows/workflow-lint.yml` invariants | `tools/scripts/test_workflow_lint.py` | Refreshed against current `origin/main`; `python3 tools/scripts/test_workflow_lint.py` reports 7 tests; temp-venv coverage over the test file passed and reported 97% for `tools/scripts/test_workflow_lint.py`; skill-sync report; version-bump report; `git diff --check`; final status clean. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-codecov-config-edges-643` | `403ad84e` | #643 static coverage-config guard tranche for `codecov.yml` invariants | `tools/scripts/test_codecov_config.py` | Refreshed against current `origin/main`; `python3 tools/scripts/test_codecov_config.py` reports 13 tests; temp-venv coverage over the test file passed and reported 99% for `tools/scripts/test_codecov_config.py`; skill-sync report; version-bump report; `git diff --check origin/main...HEAD`; final status clean. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. `codecov.yml` unchanged. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-ruleset-drift-config-643` | `6009f012` | #643 static ruleset-drift guard tranche for branch-protection JSON/workflow invariants | `tools/scripts/test_ruleset_drift_config.py` | Refreshed against current `origin/main`; `python3 tools/scripts/test_ruleset_drift_config.py` reports 6 tests; `python3 tools/scripts/test_gates.py` reports 39 tests; temp-venv coverage for the focused ruleset test reported 100% for the changed test file; skill-sync report; version-bump report; `git diff --check origin/main...HEAD`; final status clean. System `python3` lacked coverage, so the worker used a temporary venv outside the repo and removed it afterward. | When capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
...
| `local/phase3-rectangle-list-edges-641` | `7d2b2639` | #641 canvas tranche for `core/canvas/include/pulp/canvas/rectangle_list.hpp` empty/no-op edges | `test/test_rectangle_list.cpp` | Refreshed against current `origin/main` at `e60cc129`; `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug`; `cmake --build build --target pulp-test-rectangle-list -j4`; `./build/test/pulp-test-rectangle-list` passed 60 assertions in 16 test cases; `ctest --test-dir build -R 'rectangle-list\|RectangleList\|Rect ' --output-on-failure` passed 16/16; skill-sync report; version-bump report; `git diff --check`. Local configure disabled Skia/text shaping because optional `external/skia-build` was unavailable; focused rectangle-list validation passed. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
...
| `local/phase3-theme-io-validation-493` | `8ffe39c2` | #493 view tranche for `core/view/src/theme.cpp` and `core/view/include/pulp/view/theme.hpp` validation/file edge paths | `test/test_theme.cpp` | Refreshed against `origin/main` at `0300ba20`; `cmake --build build --target pulp-test-theme -j4`; `./build/test/pulp-test-theme` passed 82 assertions in 17 test cases; `ctest --test-dir build -R '^Color from hex$|^Theme |^Dark theme|^Light theme|^Pro audio theme|^Motion tokens' --output-on-failure` passed 17/17; skill-sync report; version-bump report; `git diff --check`. Build used local cached Mbed TLS after FetchContent network clone stalled; Skia/text shaping unavailable locally but theme validation passed. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-websocket-channel-edges-641` | `33e89b5b` | #641 runtime tranche for `core/runtime/src/websocket_channel.cpp` frame and handshake edge paths | `test/test_websocket_channel.cpp` | Refreshed against current `origin/main`; `cmake --build build --target pulp-test-websocket-channel -j4`; `./build/test/pulp-test-websocket-channel` passed 62 assertions in 11 test cases; `ctest --test-dir build -R 'websocket\|WebSocket' --output-on-failure` passed 11/11; skill-sync report; version-bump report; `git diff --check`. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `feature/svg-path-widget-coverage-493` | `476ca6ac` | #493 view tranche for `core/view/src/svg_path_widget.cpp` parser and degenerate path edges | `test/test_svg_path_widget.cpp` | Rebased onto current `origin/main` at `e60cc129`; `cmake --build build --target pulp-test-svg-path-widget -j4`; `./build/test/pulp-test-svg-path-widget` passed 133 assertions in 21 test cases; `ctest --test-dir build -R 'svg-path\|SvgPath' --output-on-failure` passed 21/21; skill-sync report; version-bump report; `git diff --check`; `git diff --check origin/main...HEAD`. `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows` created #1191, and explicit Namespace build dispatch `25210821512` is queued/running. | Monitor #1191; merge when required wrappers, Codecov patch, and diff coverage are green, or patch if Namespace reports a failure. |
| `local/phase3-eq-curve-view-edges-493` | `cec00003` | #493 view tranche for `core/view/src/eq_curve_view.cpp` range, hit-test, and drag callback edges | `test/test_phase9_widgets.cpp` | Refreshed against current `origin/main`; `cmake --build build --target pulp-test-phase9-widgets -j4`; `./build/test/pulp-test-phase9-widgets '[view][eq_curve]'` passed 32 assertions in 4 test cases; `ctest --test-dir build -R 'EqCurve\|eq_curve\|phase9-widgets' --output-on-failure` passed 4/4; skill-sync report; version-bump report; `git diff --check`. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
...
| `local/phase3-sdf-atlas-cache-edges-641` | `a4720af3` | #641 canvas tranche for `core/canvas/src/sdf_atlas_cache.cpp` lifecycle, rebuild, and age-eviction edges | `test/test_sdf_atlas_cache.cpp` | Refreshed against current `origin/main`; `cmake --build build --target pulp-test-sdf-atlas-cache -j4`; `./build/test/pulp-test-sdf-atlas-cache` passed 58 assertions in 9 test cases; `ctest --test-dir build -R 'sdf-atlas-cache\|SdfAtlasCache' --output-on-failure` passed 9/9; skill-sync report; version-bump report; `git diff --check`. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-image-convolution-edges-641` | `3d31df05` | #641 canvas tranche for `core/canvas/include/pulp/canvas/image_convolution.hpp` construction, stride, clamp, and standard-kernel edges | `test/test_image_convolution.cpp` | Refreshed against current `origin/main`; `cmake --build build --target pulp-test-image-convolution -j4`; `./build/test/pulp-test-image-convolution` passed 111 assertions in 12 test cases; `ctest --test-dir build -R 'ImageConvolutionKernel\|Identity kernel\|Gaussian blur\|Blur reduces contrast\|Apply on null\|Alpha channel\|Standard kernel\|Sharpen kernel' --output-on-failure` passed 12/12; skill-sync report; version-bump report; `git diff --check`. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `local/phase3-sdf-software-renderer-edges-641` | `23fdf6db` | #641 canvas tranche for `core/canvas/include/pulp/canvas/sdf_software_renderer.hpp` empty-atlas, degenerate-quad, clipping, source-bound, and max-alpha paths | `test/test_sdf_software_renderer.cpp` | Refreshed against current `origin/main`; `cmake --build build --target pulp-test-sdf-software-renderer -j4`; `./build/test/pulp-test-sdf-software-renderer` passed 1,044 assertions in 7 test cases; `ctest --test-dir build -R 'software SDF render' --output-on-failure` passed 7/7; skill-sync report; version-bump report; `git diff --check`. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
| `feature/path-to-sdf-coverage-641` | `69aa0360` | #641 canvas tranche for `core/canvas/src/path_to_sdf.cpp` dimension, spread, and mask-threshold guard edges, plus hot-reload test hardening after Windows Namespace exposed a watcher timing race | `test/test_path_to_sdf.cpp`, `test/test_hot_reload.cpp`, `test/CMakeLists.txt` | Rebased onto current `origin/main` at `7b78de80`; `cmake --build build --target pulp-test-path-to-sdf -j4`; `./build/test/pulp-test-path-to-sdf` passed 532 assertions in 6 test cases; `ctest --test-dir build -R 'path_to_sdf' --output-on-failure` passed 6/6; `cmake --build build --target pulp-test-hot-reload -j4`; `./build/test/pulp-test-hot-reload "[view][hotreload]"` passed 16 assertions in 5 test cases; `ctest --test-dir build -R 'HotReloader' --output-on-failure -j4` passed 5/5 with serialized watcher tests; skill-sync report; version-bump report; `git diff --check`. Fresh PR-event Build and Test run `25211537622` is queued/running. | Monitor #1190; merge when required wrappers, Codecov patch, and diff coverage are green, or patch if Namespace reports another failure. |
...
| `local/phase3-canvas-fallback-edges-641` | `cf949ced` | #641 canvas tranche for `core/canvas/include/pulp/canvas/canvas.hpp` fallback drawing paths | `test/test_canvas.cpp` | Refreshed against current `origin/main`; `cmake --build build --target pulp-test-canvas -j4`; `./build/test/pulp-test-canvas '[canvas][fallback]'` passed 62 assertions in 4 test cases; `./build/test/pulp-test-canvas` passed 1,260 assertions in 30 test cases; `ctest --test-dir build -R 'Canvas fallback\|SDF fallback' --output-on-failure` passed 5/5; skill-sync report; version-bump report; `git diff --check`. Broader ledger regex that also included `pulp-test-canvas` matched unrelated `pulp-test-canvas-widget_NOT_BUILT`; an attempted widget build hit local disk exhaustion, but the actual fallback cases passed. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`. |
...
| `local/phase3-system-volume-edges-640` | `5711d7e2` | #640 audio tranche for `core/audio/src/system_volume.cpp` Linux `amixer` command edges | `test/test_system_volume.cpp`, `test/CMakeLists.txt` | Refreshed against `origin/main` at `e1a22a1f`; `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug`; `cmake --build build --target pulp-test-system-volume -j4`; `./build/test/pulp-test-system-volume` passed 4 assertions in 4 test cases; `ctest --test-dir build -R 'system volume\|system mute\|system-volume' --output-on-failure` passed 4/4; skill-sync report; version-bump report; `git diff --check`. The fake-`amixer` assertions are Linux-gated, so local macOS only exercised the inert non-Linux path. | Hold local-only while Namespace pressure is high; when capacity returns, rename/push as a feature branch, run `shipyard pr --skip-target mac --skip-target ubuntu --skip-target windows`, then dispatch Namespace with `shipyard cloud run build <branch> --require-sha HEAD`; Linux-gated fake-`amixer` assertions need Namespace before merge. |
