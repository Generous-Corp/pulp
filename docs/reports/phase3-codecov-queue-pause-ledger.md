...
2026-05-05 09:11 PDT, 2026-05-05 10:59 PDT, and 2026-05-05 12:10 PDT:
added `local/phase3-streaming-writer-reopen-640` at `6f8dad35`, then
refreshed to `be1b0ec3`, then to `8693c84d`, then to `c03c7104`,
covering StreamingWriter close-on-reopen and failed-open state/header
finalization behavior for the #640 audio tranche on current
`origin/main` `6c8b9920`. Local validation passed
`cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DPULP_ENABLE_GPU=OFF -DPULP_BUILD_EXAMPLES=OFF -DFETCHCONTENT_SOURCE_DIR_MBEDTLS=/Users/danielraffel/Library/Caches/Pulp/fetchcontent-src/mbedtls-v3.6.2-tar`,
`cmake --build build --target pulp-test-audio-file -j$(sysctl -n hw.ncpu)`,
...
2026-05-05 09:15 PDT, 2026-05-05 11:02 PDT, and 2026-05-05 12:14 PDT:
added `local/phase3-frame-fill-edges-640` at `1611b10d`, then refreshed
to `7dc55715`, then to `2161075e`, then to `058a98b5`, covering
