...
Last live check: 2026-05-01 19:29:03 EDT.
...
- GitHub Actions pressure: #1229-#1230 have PR-event Build/Coverage
  checks active or queued on Namespace-backed lanes and no failed checks.
  Main changed after #1228 merged, so re-check mergeability for #1229-#1230
