...
```bash
git clone --depth 1 --recursive --branch v3.8.1_build_84 \
...
| VST3 SDK missing | `git clone --depth 1 --recursive --branch v3.8.1_build_84 https://github.com/steinbergmedia/vst3sdk.git external/vst3sdk` |
