...
Once Pulp is public, you'll be able to install directly from the Claude Code plugin marketplace:

```bash
claude plugin add pulp
```

This is not yet available. We'll update these instructions when it is.
