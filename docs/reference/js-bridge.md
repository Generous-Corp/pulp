...
| `setHitSlop` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/style_visibility_api.cpp` |
...
| `getBackground` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/style_visual_api.cpp` |
| `clearBackground` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/style_visual_api.cpp` |
...
| `setToggleBackground` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/border_box_api.cpp` |
| `setToggleBorderColor` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/border_box_api.cpp` |
| `setToggleTextColor` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/border_box_api.cpp` |
...
| `setViewEffect` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/style_effects_api.cpp` |
...
| `addBoxShadow` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/style_visual_api.cpp` |
...
| `canvasPathPolyline` | `function` | `(canvasId: string, coords: number[]) => void` | always | `-` | `core/view/src/widget_bridge/canvas2d_api.cpp` |
...
| `canvasDrawSdf` | `function` | `(canvasId: string, geometry: PulpBridgeJsonObject, sksl?: string, uniforms?: PulpBridgeJsonObject) => PulpBridgeJsonObject` | always | `-` | `core/view/src/widget_bridge/canvas2d_api.cpp` |
...
| `canvasSetShaderEffect` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/canvas2d_api.cpp` |
...
| Name | Kind | Signature | Capability | JSX | Source |
|---|---|---|---|---|---|
| `on` | `preamble_function` | `(id: string, eventName: string, fn: (...args: unknown[]) => void) => void` | always | `event:names` | `core/view/src/widget_bridge.cpp` |
...
| `claimOverlay` | `function` | `(id: string, consume?: boolean, parentId?: string) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `setOverlayTrigger` | `function` | `(id: string, isTrigger?: boolean) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `releaseOverlay` | `function` | `(id: string) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `claimDocumentNavigationFocus` | `function` | `() => boolean` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `releaseDocumentNavigationFocus` | `function` | `() => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
...
| `registerTapGesture` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `registerDoubleTapGesture` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `registerLongPressGesture` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `registerPanGesture` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `registerSwipeGesture` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `registerFlingGesture` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `registerPinchGesture` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
| `registerRotateGesture` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/event_api.cpp` |
...
| `getLayoutBoxMetrics` | `function` | `(id: string) => PulpBridgeBoxMetrics` | always | `-` | `core/view/src/widget_bridge/layout_api.cpp` |
...
| `setSubpixelLayout` | `function` | `(id: string, enabled: boolean) => void` | always | `-` | `core/view/src/widget_bridge/layout_api.cpp` |
...
| `insertChild` | `function` | `(parentId: string, childId: string, index: number) => boolean` | always | `-` | `core/view/src/widget_bridge/metadata_api.cpp` |
| `setAnchor` | `function` | `(id: string, value: string) => void` | always | `-` | `core/view/src/widget_bridge/metadata_api.cpp` |
| `setVisibleAtAnchor` | `function` | `(anchor: string, visible: boolean) => boolean` | always | `-` | `core/view/src/widget_bridge/metadata_api.cpp` |
| `bindCanvasBehaviorAt` | `function` | `(anchor: string, sourceRootId: string, canvasIndex: number, behaviorOwnerId?: string) => boolean` | always | `-` | `core/view/src/widget_bridge/metadata_api.cpp` |
...
| `__traceBegin__` | `function` | `(name: string) => void` | always | `-` | `core/view/src/widget_bridge/runtime_api.cpp` |
| `__traceEnd__` | `function` | `() => void` | always | `-` | `core/view/src/widget_bridge/runtime_api.cpp` |
| `__traceStats__` | `function` | `() => PulpBridgeTraceStats` | always | `-` | `core/view/src/widget_bridge/runtime_api.cpp` |
...
| `setSvgStretchToBounds` | `function` | `(id: string, stretch: boolean) => void` | always | `internal` | `core/view/src/widget_bridge/svg_api.cpp` |
...
| `setSvgStrokeGradient` | `function` | `(id: string, value: string) => void` | always | `prop:SvgPath.strokeGradient` | `core/view/src/widget_bridge/svg_api.cpp` |
...
| `setWidgetShader` | `function` | `(id: string, skslCode: string) => PulpBridgeJsonObject` | always | `prop:Knob.shader\|prop:Fader.shader\|prop:Toggle.shader` | `core/view/src/widget_bridge/shader_api.cpp` |
| `setWidgetShaderChart` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `setWidgetShaderUniforms` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `getWidgetShaderUniforms` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `setWidgetShaderReach` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `setWidgetShaderGeometry` | `function` | `(id: string, geometry: PulpBridgeJsonObject) => PulpBridgeJsonObject` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `bindShaderUniform` | `function` | `(id: string, uniformName: string, source: string, transform?: PulpBridgeJsonObject) => PulpBridgeJsonObject` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `bindWidgetShaderUniform` | `function` | `(id: string, uniformName: string, source: string) => PulpBridgeJsonObject` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `clearWidgetShaderUniformBindings` | `function` | `(id: string) => PulpBridgeJsonObject` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `bindWidgetShaderScope` | `function` | `(id: string, source: string) => PulpBridgeJsonObject` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `clearWidgetShaderScope` | `function` | `(id: string) => PulpBridgeJsonObject` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |
| `clearWidgetShader` | `function` | `(id: string) => PulpBridgeJsonObject` | always | `-` | `core/view/src/widget_bridge/shader_api.cpp` |

### State Binding

| Name | Kind | Signature | Capability | JSX | Source |
|---|---|---|---|---|---|
| `onParamChanged` | `preamble_function` | `(...args: unknown[]) => unknown` | always | `internal` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `offParamChanged` | `preamble_function` | `(...args: unknown[]) => unknown` | always | `internal` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `bindEvents` | `preamble_function` | `(source: string, handler: (events: Array<{frameIndex: number, value: number}>) => void) => number` | always | `internal` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `unbindEvents` | `preamble_function` | `(id: number) => boolean` | always | `internal` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `__subscribeParam__` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `__unsubscribeParam__` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `__bindEvents__` | `function` | `(source: string) => number` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `__unbindEvents__` | `function` | `(id: number) => boolean` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `getParamMetadata` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `formatParamValue` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `parseParamValue` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
...
| `bindScope` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `listValueChannels` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/state_binding_api.cpp` |
...
| `setCapturedLineBoxes` | `function` | `(id: string, boxes: Array<{ left: number; top: number; width: number; height: number; start: number; length: number }>, basisWidth: number, basisFace: string, wrapOnCacheMiss?: boolean) => void` | always | `-` | `core/view/src/widget_bridge/typography_api.cpp` |
| `clearCapturedLineBoxes` | `function` | `(id: string) => void` | always | `-` | `core/view/src/widget_bridge/typography_api.cpp` |
| `setFontSize` | `function` | `(id: string, value: number) => void` | always | `-` | `core/view/src/widget_bridge/typography_api.cpp` |
| `setTextRuns` | `function` | `(id: string, runs: Array<{ start: number; end: number; fontWeight?: number; fontSize?: number; fontFamily?: string; color?: string; fontStyle?: string; letterSpacing?: number; textDecoration?: string }>) => void` | always | `-` | `core/view/src/widget_bridge/text_runs_api.cpp` |
...
| `setKnobCapturedIndicator` | `function` | `(id: string, rIn: number, rOut: number, width: number, color: string, phaseRad?: number, colorAuthored?: boolean, outlineColor?: string, outlineWidth?: number) => void` | requires `filesystem` | `-` | `core/view/src/widget_bridge/widget_assets_api.cpp` |
| `setFaderCapturedArt` | `function` | `(id: string, ...args: unknown[]) => void` | requires `filesystem` | `-` | `core/view/src/widget_bridge/widget_assets_api.cpp` |
| `setFaderSkin` | `function` | `(id: string, trackColor?: string, fillColor?: string, thumbColor?: string, thumbBorderColor?: string, thumbWidth?: number, thumbHeight?: number, cornerRadius?: number, thumbColorAuthored?: boolean) => void` | requires `filesystem` | `-` | `core/view/src/widget_bridge/widget_assets_api.cpp` |
...
| `createSegmented` | `function` | `(id: string, parentId: string) => string` | always | `-` | `core/view/src/widget_bridge/factory_api.cpp` |
...
| `createVirtualList` | `function` | `(id: string, parentId: string) => string` | always | `-` | `core/view/src/widget_bridge/factory_api.cpp` |
| `createVirtualGrid` | `function` | `(id: string, parentId: string) => string` | always | `-` | `core/view/src/widget_bridge/factory_api.cpp` |
...
| `setToggleOn` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_controls_api.cpp` |
| `setRadioGroup` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_controls_api.cpp` |
...
| `setVirtualListRowCount` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualListOverscan` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualListSelectionMode` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualListSelected` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `scrollVirtualListToRow` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `refreshVirtualListRows` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualGridItemCount` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualGridCellSize` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualGridColumnCount` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualGridOverscan` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualGridSelectionMode` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `setVirtualGridSelected` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `scrollVirtualGridToItem` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
| `refreshVirtualGridCells` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/widget_value_list_api.cpp` |
...
| `setDesignedOverlay` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_basic_api.cpp` |
| `setItems` | `function` | `(id: string, items: string[] \| string) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_basic_api.cpp` |
| `setSegments` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/widget_value_basic_api.cpp` |
...
| `scrollTo` | `function` | `(...args: unknown[]) => unknown` | always | `prop:ScrollView.scrollTop` | `core/view/src/widget_bridge/widget_value_content_api.cpp` |
| `scrollBy` | `function` | `(...args: unknown[]) => unknown` | always | `internal` | `core/view/src/widget_bridge/widget_value_content_api.cpp` |
...
| Name | Kind | Signature | Capability | JSX | Source |
|---|---|---|---|---|---|
| `queryIndexBuild` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/query_service_api.cpp` |
| `queryIndexSearch` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/query_service_api.cpp` |
| `queryIndexRelease` | `function` | `(...args: unknown[]) => unknown` | always | `-` | `core/view/src/widget_bridge/query_service_api.cpp` |
