...
| Name | Kind | Signature | Capability | JSX | Source |
|---|---|---|---|---|---|
| `__getMeterLevel__` | `function` | `(channel: number) => number` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `__getMeterPeak__` | `function` | `(channel: number) => number` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `__getMeterChannelCount__` | `function` | `() => number` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `__registerOnFrame__` | `function` | `(callbackId: number) => number` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `__unregisterOnFrame__` | `function` | `(callbackId: number) => void` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `getMeterLevel` | `function` | `(channel: number) => number` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `getMeterPeak` | `function` | `(channel: number) => number` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `getMeterChannelCount` | `function` | `() => number` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `onFrame` | `function` | `(callback: () => void) => number` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
| `cancelFrame` | `function` | `(callbackId: number) => void` | always | `-` | `core/view/src/widget_bridge/audio_meter_api.cpp` |
