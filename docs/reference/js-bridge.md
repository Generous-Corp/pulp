...
| `setSubpixelLayout` | `function` | `(id: string, ...args: unknown[]) => void` | always | `-` | `core/view/src/widget_bridge/layout_api.cpp` |
...
| `setSvgStrokeGradient` | `function` | `(id: string, ...args: unknown[]) => void` | always | `prop:SvgPath.strokeGradient` | `core/view/src/widget_bridge/svg_api.cpp` |
