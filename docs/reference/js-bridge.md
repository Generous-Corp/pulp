...
| `setKnobCapturedIndicator` | `function` | `(id: string, rIn: number, rOut: number, width: number, color: string, phaseRad?: number, colorAuthored?: boolean) => void` | requires `filesystem` | `-` | `core/view/src/widget_bridge/widget_assets_api.cpp` |
