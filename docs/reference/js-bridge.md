...
| `onParamChanged` | `function` | `(...args: unknown[]) => unknown` | always | `internal` | `core/view/src/widget_bridge/state_binding_api.cpp` |
| `offParamChanged` | `function` | `(...args: unknown[]) => unknown` | always | `internal` | `core/view/src/widget_bridge/state_binding_api.cpp` |
