...
| `setTextSelectionRegion` | `function` | `(id: string, ...args: unknown[]) => void` | always | `prop:View.userSelect` | `core/view/src/widget_bridge/typography_api.cpp` |
| `setSelectionPolicy` | `function` | `(id: string, ...args: unknown[]) => void` | always | `prop:Label.userSelect` | `core/view/src/widget_bridge/typography_api.cpp` |
| `setReadOnly` | `function` | `(id: string, ...args: unknown[]) => void` | always | `prop:TextEditor.readOnly` | `core/view/src/widget_bridge/typography_api.cpp` |
