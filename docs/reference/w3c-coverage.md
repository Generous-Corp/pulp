...
| 17 | [Canvas 2D Context](https://html.spec.whatwg.org/multipage/canvas.html) | Living | ✅ Mostly | 30+ commands, gradients, patterns, drawImage, arc, clip, blend, text align | getImageData live-surface readback |
