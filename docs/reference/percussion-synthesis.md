...
policy; `set_variation()` is a source-API convenience that only selects one of
those same policies, not an independent baked parameter. Non-finite injected
