...
| `AnchoredCallout` | Popover anchored to a target rect | arbitrary child content, pointer triangle, side auto-flip when clipped, edge clamping, arrow tracking | `callout_box.hpp` |
