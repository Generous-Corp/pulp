...
| Explicit frequency/Q resonator bank | usable | [signal](modules.md#signal) | Processor-composition primitive; no standalone Forge node |
| Race-free spectral delay matrix | usable | [signal](modules.md#signal) | Processor-composition primitive; frame-boundary table publication |
...
`pulp/signal/bridged_t_resonator.hpp`, `pulp/signal/explicit_q_resonator_bank.hpp`,
`pulp/signal/spectral_delay_matrix.hpp`, `pulp/signal/osc/va.hpp`
...
| Versioned registered clip content with trusted, bounded note-renderer hooks | experimental | [timeline](modules.md#timeline) / [playback](modules.md#playback) | [Timeline SDK](../guides/timeline-sdk.md#compile-registered-content-with-a-trusted-renderer) | [installed SDK consumer](https://github.com/Generous-Corp/pulp/tree/main/examples/timeline-sdk-consumer); note output and reset state only, 4096-note fragment cap, trimmed nesting and nondefault-production wire serialization refused |
| Audible playhead scrubbing (repeated transport windows) | experimental | [playback](modules.md#playback) | [Timeline SDK](../guides/timeline-sdk.md#scrubbing-the-playhead) | |
...
| `pulp inspect` (deprecated profiles alias + offline artifact audit) | experimental | [cli](cli.md) |
