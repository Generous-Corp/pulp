...
| Sequential streaming source | `streaming_sample_source.hpp`, `streaming_sample_source_file.hpp` | Play a preload head plus background-filled SPSC tail; WAV uses retained mapped ranged reads while fallback codec capability remains explicit |
