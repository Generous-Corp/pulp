...
| [Fractional Delay](fractional-delay.md) | `fractional_delay.hpp` | Prepared Thiran-1 and Lagrange-3/5 delay reads with explicit causal ranges, method-correct modulation boundaries, and typed fault recovery |
