...
| Waveguide primitives | `waveguide_line.hpp`, `waveguide_reflection_filter.hpp`, `waveguide_junction.hpp`, `waveguide_reed_exciter.hpp` | Prepared bidirectional double-precision passive-interpolated delay rails with bounded retuning, passive one-pole reflection boundaries, lossless fixed-capacity scattering junctions, and a normalized nonlinear single-reed boundary. Nonlinear feedback compositions must place the complete loop inside their oversampled callback. |
