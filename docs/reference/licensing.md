...
| [Truce](https://github.com/truce-audio/truce) | Apache-2.0 / MIT | Hot-reloadable plugin DSP and sample plugins, including [reiss-mcpherson-effects](https://github.com/truce-audio/reiss-mcpherson-effects). Thanks also to [Juan Gil's JUCE implementations](https://github.com/juandagilc/Audio-Effects) and to [Joshua D. Reiss and Andrew P. McPherson](https://www.routledge.com/Audio-Effects-Theory-Implementation-and-Application/Reiss-McPherson/p/book/9781032974859), authors of *Audio Effects: Theory, Implementation and Application*. |
