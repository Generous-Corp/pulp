...
| Threading | Bounded owning-thread RPC responds after application when timely, cancels queued work during teardown, and fences started timeouts as `mayHaveApplied` while discarding late responses | Production standalone attachment |
