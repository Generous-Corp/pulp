...
constexpr auto kControlOperations =
    std::to_array<ControlOperationDescriptor>({
        ...
        PULP_RECEIPT_OPERATION(
            ...
            R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"applied":{"type":"boolean"},"client_sequence":{"maximum":9007199254740991,"minimum":0,"type":"integer"},"receipt_id":{"maxLength":128,"minLength":1,"type":"string"}},"required":["applied","client_sequence","receipt_id"],"type":"object"})",
            "receipt"),
        PULP_OPERATION(
