...
constexpr auto kControlOperations = std::to_array<ControlOperationDescriptor>({
    ...
    PULP_RECEIPT_OPERATION(
        ...
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"idempotency_key":{"maxLength":128,"minLength":1,"type":"string"},"normalized_value":{"maximum":1,"minimum":0,"type":"number"},"parameter_id":{"maximum":4294967295,"minimum":0,"type":"integer"}},"required":["parameter_id","normalized_value","idempotency_key"],"type":"object"})", R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"applied":{"type":"boolean"},"receipt_id":{"maxLength":128,"minLength":1,"type":"string"},"state_generation":{"minimum":0,"type":"integer"}},"required":["receipt_id","state_generation","applied"],"type":"object"})",
        "receipt"),
    PULP_RECEIPT_OPERATION(
        ...
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"accepted_sequence":{"minimum":0,"type":"integer"},"receipt_id":{"maxLength":128,"minLength":1,"type":"string"}},"required":["receipt_id","accepted_sequence"],"type":"object"})",
        "receipt"),
    PULP_RECEIPT_OPERATION(
    ...
    PULP_RECEIPT_OPERATION(
        ...
        "receipt"),
    PULP_OPERATION(
        GraphSampleRegionRead, "graph/sample-region.read",
        detail::kSampleRegionReadInputSchema, detail::kSampleRegionReadOutputSchema,
        "response"),
    PULP_RECEIPT_OPERATION(
        GraphSampleRegionEdit, "graph/sample-region.edit",
        detail::kSampleRegionEditInputSchema, detail::kSampleRegionEditOutputSchema,
        "receipt"),
    PULP_OPERATION(
        ...
        "artifact-chunk"),
    PULP_OPERATION(
        SequencerStateRead, "sequencer/state.read",
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"include_playhead":{"default":true,"type":"boolean"},"include_snapshot":{"default":true,"type":"boolean"},"pattern":{"maximum":31,"minimum":0,"type":"integer"}},"type":"object"})",
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"active_lane_count":{"maximum":12,"minimum":0,"type":"integer"},"active_pattern":{"maximum":31,"minimum":0,"type":"integer"},"active_pattern_count":{"maximum":32,"minimum":0,"type":"integer"},"engine_sequence":{"maximum":9007199254740991,"minimum":0,"type":"integer"},"epoch":{"maximum":9007199254740991,"minimum":0,"type":"integer"},"pattern":{"additionalProperties":false,"properties":{"index":{"maximum":31,"minimum":0,"type":"integer"},"lanes":{"items":{"items":{"additionalProperties":false,"properties":{"enabled":{"type":"boolean"},"gate_ticks":{"maximum":65535,"minimum":0,"type":"integer"},"pitch_offset":{"maximum":127,"minimum":-128,"type":"integer"},"probability":{"maximum":255,"minimum":0,"type":"integer"},"ratchet":{"maximum":255,"minimum":0,"type":"integer"},"velocity":{"maximum":255,"minimum":0,"type":"integer"}},"required":["enabled","gate_ticks","pitch_offset","probability","ratchet","velocity"],"type":"object"},"maxItems":32,"type":"array"},"maxItems":12,"type":"array"},"length":{"maximum":32,"minimum":0,"type":"integer"}},"required":["index","lanes","length"],"type":"object"},"playhead":{"additionalProperties":false,"properties":{"active_pattern":{"maximum":31,"minimum":0,"type":"integer"},"active_step":{"maximum":31,"minimum":0,"type":"integer"},"block_index":{"maximum":4294967295,"minimum":0,"type":"integer"},"playing":{"type":"boolean"},"ppq_position":{"type":"number"},"sample_time":{"maximum":9007199254740991,"minimum":0,"type":"integer"}},"required":["active_pattern","active_step","block_index","playing","ppq_position","sample_time"],"type":"object"},"playhead_included":{"type":"boolean"},"resync_required_epoch":{"maximum":9007199254740991,"minimum":0,"type":"integer"},"schema_version":{"maximum":4294967295,"minimum":1,"type":"integer"},"snapshot_included":{"type":"boolean"}},"required":["active_lane_count","active_pattern","active_pattern_count","engine_sequence","epoch","playhead_included","resync_required_epoch","schema_version","snapshot_included"],"type":"object"})",
        "response"),
    PULP_RECEIPT_OPERATION(
        SequencerStateEdit, "sequencer/state.edit",
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema","oneOf":[{"additionalProperties":false,"properties":{"cell":{"additionalProperties":false,"properties":{"enabled":{"type":"boolean"},"gate_ticks":{"maximum":65535,"minimum":0,"type":"integer"},"pitch_offset":{"maximum":127,"minimum":-128,"type":"integer"},"probability":{"maximum":255,"minimum":0,"type":"integer"},"ratchet":{"maximum":255,"minimum":0,"type":"integer"},"velocity":{"maximum":255,"minimum":0,"type":"integer"}},"required":["enabled","gate_ticks","pitch_offset","probability","ratchet","velocity"],"type":"object"},"gesture_phase":{"enum":["none","begin","update","end","cancel"]},"idempotency_key":{"maxLength":128,"minLength":1,"type":"string"},"kind":{"const":"set-cell"},"lane":{"maximum":11,"minimum":0,"type":"integer"},"pattern":{"maximum":31,"minimum":0,"type":"integer"},"step":{"maximum":31,"minimum":0,"type":"integer"},"transaction_id":{"maximum":4294967295,"minimum":0,"type":"integer"}},"required":["cell","kind","lane","pattern","step"],"type":"object"},{"additionalProperties":false,"properties":{"gesture_phase":{"enum":["none","begin","update","end","cancel"]},"idempotency_key":{"maxLength":128,"minLength":1,"type":"string"},"kind":{"const":"clear"},"lane":{"maximum":11,"minimum":0,"type":"integer"},"pattern":{"maximum":31,"minimum":0,"type":"integer"},"scope":{"enum":["cell","lane","pattern","all"]},"step":{"maximum":31,"minimum":0,"type":"integer"},"transaction_id":{"maximum":4294967295,"minimum":0,"type":"integer"}},"required":["kind","scope"],"type":"object"},{"additionalProperties":false,"properties":{"density":{"maximum":255,"minimum":0,"type":"integer"},"gesture_phase":{"enum":["none","begin","update","end","cancel"]},"idempotency_key":{"maxLength":128,"minLength":1,"type":"string"},"kind":{"const":"randomize-lane"},"lane":{"maximum":11,"minimum":0,"type":"integer"},"max_velocity":{"maximum":255,"minimum":0,"type":"integer"},"min_velocity":{"maximum":255,"minimum":0,"type":"integer"},"pattern":{"maximum":31,"minimum":0,"type":"integer"},"seed":{"maximum":4294967295,"minimum":0,"type":"integer"},"transaction_id":{"maximum":4294967295,"minimum":0,"type":"integer"}},"required":["kind","lane","pattern","seed"],"type":"object"},{"additionalProperties":false,"properties":{"gesture_phase":{"enum":["none","begin","update","end","cancel"]},"idempotency_key":{"maxLength":128,"minLength":1,"type":"string"},"kind":{"const":"set-pattern-length"},"length":{"maximum":32,"minimum":0,"type":"integer"},"pattern":{"maximum":31,"minimum":0,"type":"integer"},"transaction_id":{"maximum":4294967295,"minimum":0,"type":"integer"}},"required":["kind","length","pattern"],"type":"object"},{"additionalProperties":false,"properties":{"gesture_phase":{"enum":["none","begin","update","end","cancel"]},"idempotency_key":{"maxLength":128,"minLength":1,"type":"string"},"kind":{"const":"switch-pattern"},"pattern":{"maximum":31,"minimum":0,"type":"integer"},"transaction_id":{"maximum":4294967295,"minimum":0,"type":"integer"}},"required":["kind","pattern"],"type":"object"}]})", R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"applied":{"type":"boolean"},"client_sequence":{"maximum":9007199254740991,"minimum":0,"type":"integer"},"receipt_id":{"maxLength":128,"minLength":1,"type":"string"}},"required":["applied","client_sequence","receipt_id"],"type":"object"})",
        "receipt"),
    PULP_OPERATION(
        SequencerTransportRead, "sequencer/transport.loop.read", PULP_SCHEMA_EMPTY,
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"enabled":{"type":"boolean"},"end_tick":{"maximum":9007199254740991,"minimum":-9007199254740991,"type":"integer"},"playing":{"type":"boolean"},"sequence":{"maximum":9007199254740991,"minimum":1,"type":"integer"},"start_tick":{"maximum":9007199254740991,"minimum":-9007199254740991,"type":"integer"}},"required":["sequence","enabled","start_tick","end_tick","playing"],"type":"object"})",
        "response"),
    PULP_RECEIPT_OPERATION(
        SequencerTransportWrite, "sequencer/transport.loop.write",
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema","oneOf":[{"additionalProperties":false,"properties":{"action":{"const":"set-range"},"end_tick":{"maximum":9007199254740991,"minimum":-9007199254740991,"type":"integer"},"idempotency_key":{"maxLength":128,"minLength":1,"type":"string"},"start_tick":{"maximum":9007199254740991,"minimum":-9007199254740991,"type":"integer"}},"required":["action","start_tick","end_tick","idempotency_key"],"type":"object"},{"additionalProperties":false,"properties":{"action":{"const":"set-enabled"},"enabled":{"type":"boolean"},"expected_sequence":{"maximum":9007199254740991,"minimum":1,"type":"integer"},"idempotency_key":{"maxLength":128,"minLength":1,"type":"string"}},"required":["action","enabled","expected_sequence","idempotency_key"],"type":"object"}]})",
        R"({"$schema":"https://json-schema.org/draft/2020-12/schema","additionalProperties":false,"properties":{"action":{"enum":["set-range","set-enabled"]},"applied":{"type":"boolean"},"enabled":{"type":"boolean"},"end_tick":{"maximum":9007199254740991,"minimum":-9007199254740991,"type":"integer"},"receipt_id":{"maxLength":128,"minLength":1,"type":"string"},"sequence":{"maximum":9007199254740991,"minimum":0,"type":"integer"},"start_tick":{"maximum":9007199254740991,"minimum":-9007199254740991,"type":"integer"}},"required":["action","receipt_id","applied","enabled","start_tick","end_tick","sequence"],"type":"object"})",
        "receipt"),
});
