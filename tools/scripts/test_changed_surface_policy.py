...
class ChangedSurfacePolicyTest(unittest.TestCase):
    ...
    def test_contract_pins_registration_multiset_not_unique_names(self) -> None:
        ...
        self.assertEqual(self.contract["registration_count"], 21_147)
        self.assertEqual(self.contract["unique_name_count"], 21_088)
        self.assertEqual(self.contract["unique_composite_count"], 21_147)
