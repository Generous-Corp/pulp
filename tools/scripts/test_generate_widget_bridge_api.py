...
class WidgetBridgeApiGeneratorTest(unittest.TestCase):
    def test_generated_types_model_capability_gated_globals(self):
        ...
        self.assertRegex(dts, r"setKnobCapturedIndicator:\s+\(id: string, rIn: number, rOut: number, width: number, color: string, phaseRad\?: number, colorAuthored\?: boolean\) => void;")
