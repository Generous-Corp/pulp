...
class WidgetBridgeApiGeneratorTest(unittest.TestCase):
    def test_generated_types_model_capability_gated_globals(self):
        ...
        self.assertRegex(dts, r"setKnobCapturedIndicator:\s+\(id: string, rIn: number, rOut: number, width: number, color: string, phaseRad\?: number, colorAuthored\?: boolean, outlineColor\?: string, outlineWidth\?: number\) => void;")
        self.assertRegex(dts, r"setFaderSkin:\s+\(id: string, trackColor\?: string, fillColor\?: string, thumbColor\?: string, thumbBorderColor\?: string, thumbWidth\?: number, thumbHeight\?: number, cornerRadius\?: number, thumbColorAuthored\?: boolean\) => void;")
