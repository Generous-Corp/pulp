...
EXPORTS = [
    capability(
        ...
        lifecycle={'construction': 'control',
         ...
         'reset': 'audio',
         'release': 'control'},
        state_model='Explicit retained one-sample state and immutable prepared region bindings.',
        seed_model='none',
        input_domain='scalar audio and explicitly promoted parameters',
        output_domain='sample-synchronous audio',
        units=['samples', 'linear amplitude'],
        latency='zero reported region latency; each UnitDelay retains exactly one sample',
        tail='retained state until drained or reset',
        scheduling='bounded sample order within prepared blocks',
        key='signal.unit-delay',
        summary='Exact one-sample publish/commit memory.',
        determinism={'repeatability': 'bit_exact',
         'block_partition': 'invariant',
         'platform_scope': 'cross_platform',
         'transport_history': 'irrelevant'},
        _link_probes=[{'role': 'entrypoint',
          'binding': 'pulp::signal::UnitDelay',
        ...
        bindings=[
            binding(
                ...
                qualified_name='pulp::signal::UnitDelay',
                target='Pulp::signal',
                header_fingerprint='sha256:7e91b280e5a3a83b78ed1f84301990eee1b6dcaa8b7736f07287452896d22726',
            ),
        ],
    ),
    capability(
        ...
        tail='retained state until drained or reset',
        scheduling='bounded sample order within prepared blocks',
        key='signal.sample-region',
        summary='Bounded exact-version scalar feedback regions authored through isolated topology edits.',
        determinism={'repeatability': 'tolerance_bounded',
         'block_partition': 'invariant',
         'platform_scope': 'same_build',
         'transport_history': 'irrelevant'},
        _link_probes=[{'role': 'definition',
          'binding': 'pulp::host::SampleRegionDefinition',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'descriptor',
          'binding': 'pulp::host::SampleRegionDescriptor',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'result',
          'binding': 'pulp::host::SampleRegionResult',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'promoted_parameter',
          'binding': 'pulp::host::SampleRegionPromotedParameter',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'proof',
          'binding': 'pulp::host::SampleRegionProof',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'limits',
          'binding': 'pulp::host::SampleRegionLimits',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'kernel_config',
          'binding': 'pulp::host::SampleKernelConfig',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'kernel_descriptor',
          'binding': 'pulp::host::SampleKernelDescriptor',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'graph',
          'binding': 'pulp::host::SignalGraph',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'parameter_contract',
          'binding': 'pulp::host::SampleRegionParameterContract',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'register_graph',
          'binding': 'pulp::host::register_builtin_sample_region_types',
          'operation': 'function_call',
          'arguments': 'graph',
          'setup': 'pulp::host::SignalGraph graph;'},
         {'role': 'register_edit',
          'binding': 'pulp::host::register_builtin_sample_region_types',
          'operation': 'function_call',
          'arguments': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'begin_edit',
          'binding': 'pulp::host::SignalGraph::begin_prepared_topology_edit',
          'operation': 'member_function_call',
          'arguments': '',
          'object': 'pulp::host::SignalGraph{}'},
         {'role': 'edit_declare_sample_region',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::declare_sample_region',
          'operation': 'member_function_call',
          'arguments': 'pulp::host::SampleRegionDefinition{}',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_remove_sample_region',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::remove_sample_region',
          'operation': 'member_function_call',
          'arguments': '1',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_add_sample_region_member',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::add_sample_region_member',
          'operation': 'member_function_call',
          'arguments': '1, 1, pulp::host::SampleKernelConfig{}',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_remove_sample_region_member',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::remove_sample_region_member',
          'operation': 'member_function_call',
          'arguments': '1, 1',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_set_sample_kernel_config',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::set_sample_kernel_config',
          'operation': 'member_function_call',
          'arguments': '1, 1, pulp::host::SampleKernelConfig{}',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_connect_in_sample_region',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::connect_in_sample_region',
          'operation': 'member_function_call',
          'arguments': '1, 1, 0, 2, 0',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_prove_sample_region',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::prove_sample_region',
          'operation': 'member_function_call',
          'arguments': '1',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_sample_region',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::sample_region',
          'operation': 'member_function_call',
          'arguments': '1',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_sample_regions',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::sample_regions',
          'operation': 'member_function_call',
          'arguments': '',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_sample_region_parameter_contract',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::sample_region_parameter_contract',
          'operation': 'member_function_call',
          'arguments': '',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_prepare',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::prepare',
          'operation': 'member_function_call',
          'arguments': '48000.0, 64',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'edit_commit',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::commit',
          'operation': 'member_function_call',
          'arguments': '',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'},
         {'role': 'graph_prove_sample_region',
          'binding': 'pulp::host::SignalGraph::prove_sample_region',
          'operation': 'member_function_call',
          'arguments': '1',
          'object': 'pulp::host::SignalGraph{}'},
         {'role': 'graph_sample_region',
          'binding': 'pulp::host::SignalGraph::sample_region',
          'operation': 'member_function_call',
          'arguments': '1',
          'object': 'pulp::host::SignalGraph{}'},
         {'role': 'graph_sample_regions',
          'binding': 'pulp::host::SignalGraph::sample_regions',
          'operation': 'member_function_call',
          'arguments': '',
          'object': 'pulp::host::SignalGraph{}'},
         {'role': 'SampleRegionCandidate',
          'binding': 'pulp::host::SampleRegionCandidate',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'SampleRegionGraphProof',
          'binding': 'pulp::host::SampleRegionGraphProof',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'SampleRegionParserShape',
          'binding': 'pulp::host::SampleRegionParserShape',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'SampleRegionParserProof',
          'binding': 'pulp::host::SampleRegionParserProof',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'SampleRegionKernelNode',
          'binding': 'pulp::host::SampleRegionKernelNode',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'SampleRegionConnection',
          'binding': 'pulp::host::SampleRegionConnection',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'SampleRegionResourceStats',
          'binding': 'pulp::host::SampleRegionResourceStats',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'SampleRegionKernelRegistryView',
          'binding': 'pulp::host::SampleRegionKernelRegistryView',
          'operation': 'construct',
          'arguments': ''},
         {'role': 'proof_is_sample_region_v1_descriptor',
          'binding': 'pulp::host::is_sample_region_v1_descriptor',
          'operation': 'function_call',
          'arguments': 'pulp::host::SampleKernelDescriptor{}'},
         {'role': 'proof_sample_region_config_matches',
          'binding': 'pulp::host::sample_region_config_matches',
          'operation': 'function_call',
          'arguments': 'pulp::host::SampleKernelConfig{}, pulp::host::SampleKernelDescriptor{}'},
         {'role': 'proof_prove_sample_region',
          'binding': 'pulp::host::prove_sample_region',
          'operation': 'function_call',
          'arguments': 'pulp::host::SampleRegionCandidate{}'},
         {'role': 'proof_prove_sample_regions',
          'binding': 'pulp::host::prove_sample_regions',
          'operation': 'function_call',
          'arguments': '{}'},
         {'role': 'proof_prove_sample_region_parser_shape',
          'binding': 'pulp::host::prove_sample_region_parser_shape',
          'operation': 'function_call',
          'arguments': 'pulp::host::SampleRegionParserShape{}'},
         {'role': 'contract_from_regions',
          'binding': 'pulp::host::SampleRegionParameterContract::from_regions',
          'operation': 'function_call',
          'arguments': '{}'},
         {'role': 'contract_freeze',
          'binding': 'pulp::host::SampleRegionParameterContract::freeze',
          'operation': 'member_function_call',
          'arguments': '{}',
          'object': 'pulp::host::SampleRegionParameterContract::from_regions({})'},
         {'role': 'contract_bind',
          'binding': 'pulp::host::SampleRegionParameterContract::bind',
          'operation': 'member_function_call',
          'arguments': 'store',
          'object': 'contract',
          'setup': 'pulp::state::StateStore store; auto contract = '
                   'pulp::host::SampleRegionParameterContract::from_regions({}).freeze({});'},
         {'role': 'edit_bind_parameters',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::bind_sample_region_parameters',
          'operation': 'member_function_call',
          'arguments': '*binding',
          'object': '*edit',
          'setup': 'pulp::state::StateStore store; auto contract = '
                   'pulp::host::SampleRegionParameterContract::from_regions({}).freeze({}); auto '
                   'binding = contract.bind(store); if (!binding) return 1; pulp::host::SignalGraph '
                   'graph; auto edit = graph.begin_prepared_topology_edit();'},
         {'role': 'edit_add_exact_node',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::add_custom_node',
          'operation': 'member_function_call',
          'arguments': '"pulp.core.sample-region.input", 1, "Input"',
          'object': '*edit',
          'setup': 'pulp::host::SignalGraph graph; auto edit = graph.begin_prepared_topology_edit(); '
                   'pulp::host::register_builtin_sample_region_types(*edit);'},
         {'role': 'edit_connect',
          'binding': 'pulp::host::SignalGraph::PreparedTopologyEdit::connect',
          'operation': 'member_function_call',
          'arguments': '1, 0, 2, 0',
          'object': '*pulp::host::SignalGraph{}.begin_prepared_topology_edit()'}],
        contract_version={'major': 1, 'minor': 0},
        ...
        bindings=[
            binding(
                ...
                qualified_name='pulp::host::SampleRegionDefinition',
                target='Pulp::host',
                header_fingerprint='sha256:15e798963f6115b371c9a644de16619a6ea10e5c797845b25db72c14301ebaf7',
            ),
            binding(
                role='descriptor',
                kind='cpp_type',
                include='pulp/host/sample_region_authoring.hpp',
                qualified_name='pulp::host::SampleRegionDescriptor',
                target='Pulp::host',
                header_fingerprint='sha256:15e798963f6115b371c9a644de16619a6ea10e5c797845b25db72c14301ebaf7',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_authoring.hpp',
                qualified_name='pulp::host::SampleRegionResult',
                target='Pulp::host',
                header_fingerprint='sha256:15e798963f6115b371c9a644de16619a6ea10e5c797845b25db72c14301ebaf7',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_authoring.hpp',
                qualified_name='pulp::host::SampleRegionPromotedParameter',
                target='Pulp::host',
                header_fingerprint='sha256:15e798963f6115b371c9a644de16619a6ea10e5c797845b25db72c14301ebaf7',
            ),
            binding(
                ...
                qualified_name='pulp::host::SampleRegionProof',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                role='limits',
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionLimits',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
            ...
            binding(
                ...
                qualified_name='pulp::host::SampleRegionParameterContract',
                target='Pulp::host',
                header_fingerprint='sha256:39d608c270c2714a56d0f6213d75837abfead2b271503e02b597ddf6f21e8c25',
            ),
            binding(
                role='register_graph',
                kind='cpp_function',
            ...
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionCandidate',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionGraphProof',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionParserShape',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionParserProof',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionKernelNode',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionConnection',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionResourceStats',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_type',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::SampleRegionKernelRegistryView',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_function',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::is_sample_region_v1_descriptor',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_function',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::sample_region_config_matches',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_function',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::prove_sample_region',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_function',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::prove_sample_regions',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_function',
                include='pulp/host/sample_region_proof.hpp',
                qualified_name='pulp::host::prove_sample_region_parser_shape',
                target='Pulp::host',
                header_fingerprint='sha256:f40d8f2adf1ba7cb5c2b5e415d1f8c0219b95eb9c470f89041e9f45569f8f4a4',
            ),
            binding(
                ...
                kind='cpp_function',
                include='pulp/host/sample_region_parameters.hpp',
                qualified_name='pulp::host::SampleRegionParameterContract::from_regions',
                target='Pulp::host',
                header_fingerprint='sha256:39d608c270c2714a56d0f6213d75837abfead2b271503e02b597ddf6f21e8c25',
            ),
            binding(
                ...
                kind='cpp_function',
                include='pulp/host/sample_region_parameters.hpp',
                qualified_name='pulp::host::SampleRegionParameterContract::freeze',
                target='Pulp::host',
                header_fingerprint='sha256:39d608c270c2714a56d0f6213d75837abfead2b271503e02b597ddf6f21e8c25',
            ),
            binding(
                ...
                kind='cpp_function',
                include='pulp/host/sample_region_parameters.hpp',
                qualified_name='pulp::host::SampleRegionParameterContract::bind',
                target='Pulp::host',
                header_fingerprint='sha256:39d608c270c2714a56d0f6213d75837abfead2b271503e02b597ddf6f21e8c25',
            ),
            binding(
