...
SIGNATURE_OVERRIDES: dict[str, str] = {
    ...
    "setFaderSkin": "(id: string, trackColor?: string, fillColor?: string, thumbColor?: string, thumbBorderColor?: string, thumbWidth?: number, thumbHeight?: number, cornerRadius?: number, thumbColorAuthored?: boolean) => void",
    ...
    "setKnobCapturedIndicator": "(id: string, rIn: number, rOut: number, width: number, color: string, phaseRad?: number, colorAuthored?: boolean, outlineColor?: string, outlineWidth?: number) => void",
    ...
    "bindCanvasBehaviorAt": "(anchor: string, sourceRootId: string, canvasIndex: number, behaviorOwnerId?: string) => boolean",
    ...
    "setWidgetShaderGeometry": "(id: string, geometry: PulpBridgeJsonObject) => PulpBridgeJsonObject",
    "bindShaderUniform": "(id: string, uniformName: string, source: string, transform?: PulpBridgeJsonObject) => PulpBridgeJsonObject",
    "bindWidgetShaderUniform": "(id: string, uniformName: string, source: string) => PulpBridgeJsonObject",
    "clearWidgetShaderUniformBindings": "(id: string) => PulpBridgeJsonObject",
