...
# Vendored at 2.1.2. Upstream fetched the version via
# `importlib.metadata.version('lcov_cobertura')`, which only resolves when
# the package is pip-installed. Hardcoding keeps this script
# self-contained so scripts/run_coverage.sh doesn't need a pip step in CI.
# Pulp vendor: 2026-04-21.
__version__ = "2.1.2"
