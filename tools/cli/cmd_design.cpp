// cmd_design.cpp — `pulp design`: route offline verbs, else launch the tool.
//
// The offline subcommand handlers live in cmd_design_subcommands.cpp; this file
// dispatches to them and otherwise discovers the project, builds, and launches
// the live GPU design tool.
...
int cmd_design(const std::vector<std::string>& args) {
    using namespace pulp::cli::design;
