...
void print_compare_usage() {
    std::cout <<
        ...
        "                                       trims a constant delay/offset; varispeed:R undoes a declared\n"
        "                                       tape-speed change (resample); stretch:R declares a pitch-\n"
        "                                       preserving time-stretch; pitch:S a duration-preserving shift\n"
        "                                       (S semitones); ratio:auto estimates a uniform stretch ratio.\n"
