...
void print_compare_usage() {
    std::cout <<
        ...
        "  --align <none|latency|varispeed:R|stretch:R>  time-align first: latency trims a constant\n"
        "                                       delay/offset; varispeed:R undoes a declared tape-speed change\n"
        "                                       (resample); stretch:R declares a pitch-preserving time-stretch.\n"
