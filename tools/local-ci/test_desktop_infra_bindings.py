...
class DesktopInfraBindingsTests(unittest.TestCase):
    ...
    def test_install_desktop_infra_helpers_routes_selected_groups(self) -> None:
        bindings = {}
        names = ("normalize_git_remote_for_http", "slugify_token", "wait_for_path")
    ...
    def test_install_desktop_infra_helpers_preserves_unknown_fallback(self) -> None:
        bindings = {}
        ...
        with (
            ...
            self.mod.install_desktop_infra_helpers(bindings, ("custom",))

        git.assert_called_once_with(bindings, ())
