...
class DesktopDoctorWebdriverProbeBindingsTests(unittest.TestCase):
    ...
    def test_install_desktop_doctor_webdriver_probe_helpers_keeps_unknown_local_fallback(self):
        bindings = {}
        self.mod.future_desktop_doctor_webdriver_probe_helper = lambda _bindings: "future"

        self.mod.install_desktop_doctor_webdriver_probe_helpers(bindings, ("future_desktop_doctor_webdriver_probe_helper",))

        self.assertEqual(bindings["future_desktop_doctor_webdriver_probe_helper"](), "future")
