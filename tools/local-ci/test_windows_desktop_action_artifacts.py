#!/usr/bin/env python3
"""No-network tests for Windows desktop action artifact manifest helpers."""
...
MODULE_PATH = Path(__file__).resolve().with_name("windows_desktop_action_artifacts.py")
...
class WindowsDesktopActionArtifactsTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_attach_before_diff_and_ui_snapshot_artifacts(self) -> None:
        ...
        self.mod.attach_windows_before_diff_artifacts(
            manifest,
            capture_before=True,
        ...
        self.mod.attach_windows_ui_snapshot(
            manifest,
