"""Bindings from the local_ci facade to the desktop recent report command."""
...
def install_desktop_report_recent_command_helpers(
    bindings: dict[str, Any],
    names: tuple[str, ...] = DESKTOP_REPORT_RECENT_COMMAND_EXPORTS,
) -> None:
    known_names = set(DESKTOP_REPORT_RECENT_COMMAND_EXPORTS)
