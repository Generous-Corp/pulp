...
class LocalCiPrShipCommandBindingsTests(unittest.TestCase):
    ...
    def test_install_local_ci_pr_ship_command_helpers_keeps_unknown_local_fallback(self):
        bindings = {}
        self.mod.future_local_ci_pr_ship_command_helper = lambda _bindings: "future"

        self.mod.install_local_ci_pr_ship_command_helpers(bindings, ("future_local_ci_pr_ship_command_helper",))

        self.assertEqual(bindings["future_local_ci_pr_ship_command_helper"](), "future")
