...
class DesktopCommandsCliTests(unittest.TestCase):
    ...
    def test_desktop_video_matrix_outputs_text_json_and_markdown(self):
        ...
        self.assertIn("--manifest-map-output /tmp/reaper-plugin-editor-video-review-manifest-map.json", reaper["review_issue_command"])
    ...
    def test_find_executable_path_uses_common_fallbacks(self):
        ...
        self.assertIn("iOS Pulp HostApp interaction", markdown)
        self.assertIn("PulpSineSynth_HostApp_Embed", markdown)
        self.assertIn("-DCMAKE_SYSTEM_NAME=iOS", markdown)
        self.assertIn("build-ios-sim-video-proof/AUv3/Release/PulpSineSynth.app", markdown)
        self.assertIn("com.pulp.examples.sinesynth.host", markdown)
        ...
        self.assertIn("desktop review-watch --repo owner/repo --label video-review", markdown)
        self.assertIn("--manifest-map-output /tmp/ios-simulator-video-review-manifest-map.json", markdown)
