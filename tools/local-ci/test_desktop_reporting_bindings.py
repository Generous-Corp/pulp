...
class DesktopReportingBindingsTests(unittest.TestCase):
    ...
    def test_install_desktop_reporting_helpers_routes_proof_exports(self):
        captured = {}
        ...
        self.mod.install_desktop_reporting_helpers(bindings, ("desktop_proof_summaries",))

        result = bindings["desktop_proof_summaries"]({"desktop_automation": {}}, target_name="mac")
