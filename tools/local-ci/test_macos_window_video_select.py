...
MODULE_PATH = Path(__file__).with_name("macos_window_video_select.py")


def load_module():
    spec = importlib.util.spec_from_file_location("macos_window_video_select_under_test", MODULE_PATH)
