...
| `desktop_cli.py` | Desktop automation CLI line fragments for action success, recent-run, and proof output. | Target execution, artifact persistence, report rollups, proof selection, or desktop action policy. |
