...
| `desktop_cli.py` | Desktop automation CLI line fragments for config, action success, recent-run, proof, publish, and cleanup output. | Target execution, artifact persistence, report rollups, proof selection, or desktop action policy. |
