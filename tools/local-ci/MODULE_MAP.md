...
| --- | --- | --- |
| Desktop action orchestration | Launch adapters, local/remote automation adapters, and desktop action command execution. Shared action helper policy is already isolated in `desktop_actions.py`; desktop management command wrappers live in `desktop_commands_cli.py`. | later desktop automation module |
