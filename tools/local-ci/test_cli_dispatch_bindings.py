...
class CliDispatchBindingsTests(unittest.TestCase):
    ...
    def test_cmd_desktop_binds_facade_commands(self):
        ...
        self.assertEqual(
            ...
            {"install", "doctor", "video-doctor", "video-setup", "status", "config", "recent", "proof", "publish", "verdict", "review-issue", "review-status", "compose-video", "design-diff", "video-matrix", "serve", "video", "cleanup", "smoke", "click", "inspect"},
        )
