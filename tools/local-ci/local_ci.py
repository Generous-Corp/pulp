...
for _cloud_helper_name in _CLOUD_HELPER_EXPORTS:
    globals()[_cloud_helper_name] = _cloud_bindings.bind_cloud_helper(globals(), _cloud_helper_name)
del _cloud_helper_name
