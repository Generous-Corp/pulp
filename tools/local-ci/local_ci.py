...
def cmd_desktop_review_status(args: argparse.Namespace) -> int:
...
def cmd_simulator_video_doctor(args: argparse.Namespace) -> int:
    return _simulator_video_commands_cli.cmd_simulator_video_doctor(args)
