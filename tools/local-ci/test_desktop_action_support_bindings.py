...
class DesktopActionSupportBindingsTests(unittest.TestCase):
    ...
    def test_install_desktop_action_support_helpers_keeps_unknown_local_fallback(self) -> None:
        bindings = {}
        self.mod.future_desktop_action_support_helper = lambda _bindings: "future"

        self.mod.install_desktop_action_support_helpers(bindings, ("future_desktop_action_support_helper",))

        self.assertEqual(bindings["future_desktop_action_support_helper"](), "future")
