...
class DesktopRunRollupBindingsTests(unittest.TestCase):
    ...
    def test_install_desktop_run_rollup_helpers_routes_each_group(self):
        bindings = {}
        ...
        with (
            ...
            self.mod.install_desktop_run_rollup_helpers(
                bindings,
                ("desktop_run_manifests", "write_desktop_run_rollups"),
            )
    ...
    def test_install_desktop_run_rollup_helpers_preserves_unknown_fallbacks(self):
        bindings = {"custom": object()}

        with mock.patch.object(self.mod, "install_local_helpers") as install_local:
            self.mod.install_desktop_run_rollup_helpers(bindings, ("custom",))
