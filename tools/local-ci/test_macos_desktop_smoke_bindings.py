...
MODULE_PATH = Path(__file__).with_name("macos_desktop_smoke_bindings.py")
...
class MacosDesktopSmokeBindingsTests(unittest.TestCase):
    ...
    def test_install_macos_desktop_smoke_helpers_wires_named_exports(self):
        captured = {}
        ...
        self.mod.install_macos_desktop_smoke_helpers(bindings)

        self.assertEqual(
            bindings["run_macos_local_smoke"](
                {"desktop_automation": {}},
                "/tmp/app",
                action_name="smoke",
                bundle_id=None,
