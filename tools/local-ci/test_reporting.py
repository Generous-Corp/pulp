...
class ReportingTests(unittest.TestCase):
    ...
    def test_stage_desktop_publish_report_copies_artifacts_and_writes_index(self) -> None:
        ...
        self.assertIn("--auto-port", review_package["serve_background_command"])
        ...
        self.assertIn("--auto-port", review_package["runs"][0]["fallback"]["serve_background_command"])
        ...
        self.assertIn("--auto-port", review_text)
