#!/usr/bin/env python3
"""No-network tests for Windows remote desktop doctor checks."""
...
MODULE_PATH = pathlib.Path(__file__).with_name("desktop_doctor_remote_windows.py")
...
class DesktopDoctorRemoteWindowsTests(unittest.TestCase):
    def setUp(self) -> None:
