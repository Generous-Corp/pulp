// Build the executable @pulp/react entry for a validated materialized browser
// document. CLI parsing, file I/O, and esbuild orchestration live in the
// materialized-runtime-transform command.
import {
