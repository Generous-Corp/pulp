...
```cpp
// Reading a clock or gate input — always Schmitt, never a bare comparison.
bool high = false;
if (!high && v >= V::kSchmittHigh) { high = true; /* rising edge */ }
else if (high && v <= V::kSchmittLow) { high = false; }
