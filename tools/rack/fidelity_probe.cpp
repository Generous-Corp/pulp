...
// One synchronized capture can now carry the complete acid behavior contract:
// clock, raw/post-slew pitch, accent, slide, cutoff/filter evidence, and final
// audio. Keeping these in one module avoids comparing independently launched
// sequencers whose phase only happens to look aligned.
