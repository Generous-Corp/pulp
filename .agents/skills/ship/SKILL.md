...
the existing string format in each file (`v0.92.1` in `tools/shipyard.toml`,
`0.92.1` in the workflow env — the `v` prefix is intentional only on the toml).
...
--check --json` to report local drift and `shipyard update --to v0.92.1`
