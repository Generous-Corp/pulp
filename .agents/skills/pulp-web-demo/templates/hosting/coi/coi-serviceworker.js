/*! coi-serviceworker v0.1.7 — Guido Zuidhof / coi-serviceworker contributors, MIT.
 *  Vendored VERBATIM by the pulp-web-demo generator as the WCLAP github-pages+coi FALLBACK.
 *  Prefer a header-capable host (Cloudflare _headers). This shim reloads the page into a
 *  synthetic cross-origin-isolated context by injecting COOP/COEP on same-origin responses.
 *  Owned file — regenerated from the bundled template; do not hand-edit.
 */
